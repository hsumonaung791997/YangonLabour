							    ...
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="numholidays" name="numholidays" type="radio" value="ရှိ" @if($templeave->numholidays=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="numholidays">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="numholidays1"  type="radio" name="numholidays" value="မရှိ" @if($templeave->numholidays=='မရှိ') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="opportunityhol" name="opportunityhol" type="radio" value="ပြု" @if($templeave->opportunityhol=='ပြု') checked @endif>
										  <label class="custom-control-label" for="opportunityhol">ပြု</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="opportunityhol1" checked="" type="radio" name="opportunityhol" value="မပြု" @if($templeave->opportunityhol=='မပြု') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="paidwage" name="paidwage" type="radio" value="ရှိ" @if($templeave->paidwage=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="paidwage">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="paidwage1"  type="radio" name="paidwage" value="မရှိ" @if($templeave->paidwage=='မရှိ') checked @endif>
			...
			<legend class="scheduler-border">လုပ်သက်ခွင့်ရက်ကို နှစ်စဉ် ခံစားခွင့်  </legend>
				<div class="control-group">
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays" name="vacationdays" type="radio" value="ပေး" @if($templeave->vacationdays=='ပေး') checked @endif>
								<label class="custom-control-label" for="vacationdays">ပေး </label>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays1" checked="" type="radio" name="vacationdays" value="မပေး" @if($templeave->vacationdays=='မပေး') checked @endif>
			...
			<legend class="scheduler-border">အလုပ်မှ နုတ်ထွက် ထုတ်ပြစ်သော လုပ်သားများအား ခွင့်ရက်အစား အခကြေးငွေကို ရှင်းပေးခြင်း</legend>
				<div class="control-group">
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees" name="workerfrees" type="radio" value="ရှိ" @if($templeave->workerfrees=='ရှိ') checked @endif>
								<label class="custom-control-label" for="workerfrees">ရှိ </label>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees1"  type="radio" name="workerfrees" value="မရှိ" @if($templeave->workerfrees=='မရှိ') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="annual" name="annual" type="radio" value="ရှိ" @if($templeave->annual=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="annual">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="annual1"  type="radio" name="annual" value="မရှိ" @if($templeave->annual=='မရှိ') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="contract" name="contract" type="radio" value="ရှိ" @if($templeave->contract=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="contract">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="contract1"  type="radio" name="contract" value="မရှိ" @if($templeave->contract=='မရှိ') checked @endif>
  				...
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="registrationbook" name="registrationbook" type="radio" value="ရှိ" @if($templeave->registrationbook=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="registrationbook">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="registrationbook1"  type="radio" name="registrationbook" value="မရှိ" @if($templeave->registrationbook=='မရှိ') checked @endif>
  		...
  		<div class="col-sm-6">
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-12">
                                     <input type="text" name="medicalticketqan" value="{{$templeave->medicalticketqan}}"/>
								 	</div>
								 </div>
						    </div>
				</fieldset>
...
<p>
	...
	<div class="row">
		<div class="col-sm-6 text-center">
		  	<textarea class="col-sm-12" rows="4" placeholder="ယခင်က ပြစ်မှုထင်ရှား စီရင်ခြင်း ခံရလျှင် အဆိုပါ အကြောင်းအရာများကို ဖော်ပြရန်" id="letter" name="passionremark">{{$templeave->passionremark}}</textarea>		
		  			
		</div>
		<div class="col-sm-6 text-center">
        <textarea class="col-sm-12" rows="4" placeholder="အထွေထွေမှတ်ချက်များ" id="letter" name="generalremark">{{$templeave->generalremark}}</textarea>		
		  			
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12 text-center">
		  	<textarea class="col-sm-12" rows="4" placeholder="အထက်အရာရှိမှတ်ချက်" id="letter" name="officeremark">{{$templeave->officeremark}}</textarea>		
	...
	<div class="row">
		...
		<div class="col-sm-5 text-center">
		  		<input type="text" name="inspectionname" id="inspectionname" value="{{$templeave->inspectionname}}">	
