...
<form id="shopinspect" action="{{route('ShopLabourInspectionLaw.store')}}" method="post">
	 ...
	 <div style="text-align:center;margin-top:40px;">
	  ...
	  {{-- township_id --}}
	<input type="hidden" value="{{$tempshopLabourLaw->township_id}}" name="township_id">
	  {{--  --}}
							    ...
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="numholidays" name="numholidays" type="radio" value="ရှိ" @if($tempshopLabourLaw->numholidays=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="numholidays">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="numholidays1" type="radio" name="numholidays" value="မရှိ" @if($tempshopLabourLaw->numholidays=='မရှိ') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="opportunityhol" name="opportunityhol" type="radio" value="ပြု" @if($tempshopLabourLaw->opportunityhol=='ပြု') checked @endif>
										  <label class="custom-control-label" for="opportunityhol">ပြု</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="opportunityhol1"  type="radio" name="opportunityhol" value="မပြု" @if($tempshopLabourLaw->opportunityhol=='မပြု') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="paidwage" name="paidwage" type="radio" value="ရှိ" @if($tempshopLabourLaw->paidwage=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="paidwage">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="paidwage1"  type="radio" name="paidwage" value="မရှိ" @if($tempshopLabourLaw->paidwage=='မရှိ') checked @endif>
			...
			<legend class="scheduler-border">လုပ်သက်ခွင့်ရက်ကို နှစ်စဉ် ခံစားခွင့်  </legend>
				<div class="control-group">
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays" name="vacationdays" type="radio" value="ပေး" @if($tempshopLabourLaw->vacationdays=='ပေး') checked @endif>
								<label class="custom-control-label" for="vacationdays">ပေး </label>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays1"  type="radio" name="vacationdays" value="မပေး" @if($tempshopLabourLaw->vacationdays=='မပေး') checked @endif>
			...
			<legend class="scheduler-border">အလုပ်မှ နုတ်ထွက် ထုတ်ပြစ်သော လုပ်သားများအား ခွင့်ရက်အစား အခကြေးငွေကို ရှင်းပေးခြင်း</legend>
				<div class="control-group">
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees" name="workerfrees" type="radio" value="ရှိ" @if($tempshopLabourLaw->workerfrees=='ရှိ') checked @endif>
								<label class="custom-control-label" for="workerfrees">ရှိ </label>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees1"  type="radio" name="workerfrees" value="မရှိ" @if($tempshopLabourLaw->workerfrees=='မရှိ') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="annual" name="annual" type="radio" value="ရှိ" @if($tempshopLabourLaw->annual=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="annual">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="annual1"  type="radio" name="annual" value="မရှိ" @if($tempshopLabourLaw->annual=='မရှိ') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="contract" name="contract" type="radio" value="ရှိ" @if($tempshopLabourLaw->contract=='မရှိ') checked @endif>
										  <label class="custom-control-label" for="contract">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="contract1"  type="radio" name="contract" value="မရှိ" @if($tempshopLabourLaw->contract=='မရှိ') checked @endif>
  				...
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="registrationbook" name="registrationbook" type="radio" value="ရှိ" @if($tempshopLabourLaw->registrationbook=='ရှိ') checked @endif>
										  <label class="custom-control-label" for="registrationbook">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="registrationbook1"  type="radio" name="registrationbook" value="မရှိ" @if($tempshopLabourLaw->registrationbook=='မရှိ') checked @endif>
  		...
  		<div class="col-sm-6">
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-12">
                                     <input type="text" name="medicalticketqan" value="{{$tempshopLabourLaw->medicalticketqan}}"/>
								 	</div>
								 </div>
						    </div>
				</fieldset>
...
<p>
	...
	<div class="row">
		<div class="col-sm-6 text-center">
        <textarea class="col-sm-12" rows="4" placeholder="ယခင်က ပြစ်မှုထင်ရှား စီရင်ခြင်း ခံရလျှင် အဆိုပါ အကြောင်းအရာများကို ဖော်ပြရန်" id="letter" name="passionremark">{{$tempshopLabourLaw->passionremark}}</textarea>		
		  			
		</div>
		<div class="col-sm-6 text-center">
		  	<textarea class="col-sm-12" rows="4" placeholder="အထွေထွေမှတ်ချက်များ" id="letter" name="generalremark">{{$tempshopLabourLaw->generalremark}}</textarea>		
		  			
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12 text-center">
		  	<textarea class="col-sm-12" rows="4" placeholder="အထက်အရာရှိမှတ်ချက်" id="letter" name="officeremark">{{$tempshopLabourLaw->officeremark}}</textarea>		
    ...
    <p>
            <div class="row">
               <div class="col-sm-12">
                    ...
                    <textarea rows="4" class="col-sm-12" name="work_duration" id="workduration">  
                        {{$tempshopLabourLaw->work_duration}} 
                    </textarea>
                </div>
         ...
         <!-- //for factory id -->
    <input type="hidden" name="shop_id" id="shop_id" value="{{$tempshopLabourLaw->shop_id}}">
  <!-- For new design-->
            <p>
                <div class="row">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                 <div class="row">
                                    <div class="col-sm-6 text-center">
                                        <div class="custom-control custom-radio mb-3">
                                          <input class="custom-control-input" id="worktimenotice" name="worktime_notice" type="radio" value="ပြု" @if($tempshopLabourLaw->worktime_notice=='ပြု') checked @endif>
                                          <label class="custom-control-label" for="worktimenotice">ပြု</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="worktimenotice1"  type="radio" name="worktime_notice" value="မပြု" @if($tempshopLabourLaw->worktime_notice=='မပြု') checked @endif>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6 text-center">
                                        <div class="custom-control custom-radio mb-3">
                                          <input  class="custom-control-input" id="SSB" name="SSB" type="radio" value="ထား" @if($tempshopLabourLaw->SSB=='ထား') checked @endif>
                                          <label class="custom-control-label" for="SSB">ထား</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="SSB1"  type="radio" name="SSB" value="မထား" @if($tempshopLabourLaw->SSB=='မထား') checked @endif>
  ...
  <!-- For new design-->
            ...
            <p>
                <div class="row">               
                    <div class="col-sm-5 text-center">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6 text-center">
                                        <div class="custom-control custom-radio mb-3">
                                          <input  class="custom-control-input" id="salarytime" name="salary_time" type="radio" value="ပေး" @if($tempshopLabourLaw->salary_time=='ပေး') checked @endif>
                                          <label class="custom-control-label" for="salarytime">ပေး</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="salarytime1"  type="radio" name="salary_time" value="မပေး" @if($tempshopLabourLaw->salary_time=='မပေး') checked @endif>
                    ...
                    <input type="text" id='weekendholiday' name="weekend_holiday" value="{{$tempshopLabourLaw->weekend_holiday}}"/>
                    </div>
                </div>
            </p>
	...
	<div class="row">
		...
		<div class="col-sm-5 text-center">
		  		<input type="text" name="inspectionname" id="inspectionname" value="{{$tempshopLabourLaw->inspectionname}}">	
