	 ...
	 {{csrf_field()}}
	  ...
	  <div class="tab">
	  		...
	  		<div class="row">
				  ...
				  <input id="shopname" class="form-control" name="shopname" value="{{old('shopname')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input id="shopemail" class="form-control" name="shopemail" value="{{old('shopemail')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  				...
	  				<input id="shopfax" class="form-control" name="shopfax" value="{{old('shopfax')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input id="shopphone" class="form-control" name="shopphone" value="{{old('shopphone')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			...
	  			<div class="col-sm-6 text-center">
					...
					<input id="ownerphone" class="form-control" name="ownerphone" value="{{old('ownerphone')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					...
					<input id="mangername" class="form-control" name="mangername" value="{{old('mangername')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
					...
					<input id="managernrc" class="form-control" name="managernrc" value="{{old('managernrc')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					...
					<input id="manageraddress" class="form-control" name="manageraddress" value="{{old('manageraddress')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
					...
					<input id="managerphone" class="form-control" name="managerphone" value="{{old('managerphone')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					...
					<input id="managerfax" class="form-control" name="managerfax" value="{{old('managerfax')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
					...
					<input id="manageremail" class="form-control" name="manageremail" value="{{old('manageremail')}}">
	  			</div>
	  		</div>
					...
					<fieldset class="scheduler-border">
					    ...
					    <div class="control-group">
					    	<div class="row">
								...
								<div class="col-sm-6">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="operate24hr1"  type="radio" name="operate24hr" value=1 @if(old('operate24hr')==1) checked @endif>
		  		...
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<div class="row">
						   ...
						   <div class="col-sm-4">
							   <div class="custom-control custom-radio mb-3">
								   <input  class="custom-control-input" id="TypeofShop1"  type="radio" value="လတ်" name="shoptype" @if(old('shoptype')=='လတ်') checked @endif>
								   <label class="custom-control-label" for="TypeofShop1">လတ်</label>
							   </div>
						   </div>
						   <div class="col-sm-4">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="TypeofShop2"  type="radio" value="သေး" name="shoptype" @if(old('shoptype')=='သေး') checked @endif>
					    ...
					    <div class="control-group">
					    	<div class="row">
								...
								<div class="col-sm-6 text-left">
									...
									@foreach($region as $r)
									<option value={{$r->id}} @if(old('region_id')==$r->id) selected @endif >{{$r->region_name}}</option>
									@endforeach
									</select>
								</div>
							</div> <br>
					...
					<div class="row">
						...
						<div class="col-sm-6 text-left">
					    	...
					    	<div class="row">
					    		...
					    		<div class="col-sm-6 text-left">
								<textarea class="form-control form-control-alternative" rows="3" placeholder="အသေးစိတ်ထည့်ရန်" id='address' name="loacationaddress">{{old('loacationaddress')}}</textarea>
					    		</div>
					    	</div>
						  ...
						  <div class="control-group">
							   <div class="row">
								   <div class="col-sm-5 text-center">
									   ...
									   <select name="section_id" id="section_id" class="form-control">
										  ...
										  @foreach ($section as $s )
										   <option value="{{$s->id}}" @if(old('section_id')==$s->id) selected @endif>{{$s->SectionName}}</option>
										  @endforeach
									  </select>
								  </div>
								  <div class="col-sm-1">
								  ...
								  <div class="col-sm-6">
									  <label for="division_id">Division</label>
									   ...
									   <option value="{{old('division_id')}}">Choose Division</option>
									  </select>
								  </div>
							   </div>
							   ...
							   <div class="row">
								  <div class="col-sm-5 text-center">
									  ...
									  <option value="{{old('group_id')}}">Choose Group</option>
									 </select>
								 </div>
								 <div class="col-sm-1">
								 ...
								 <div class="col-sm-6">
									 <label for="class_name">Class</label>
									  ...
									  <option value="{{old('class_name')}}">Choose Class</option>
									 </select>
								 </div>
							  </div>
	  ...
	  <div class="tab">
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					  ...
					  {{-- <input id="PropertyType"  name="PropertyType"> --}}
	  		...
	  		<div class="row">
				  ...
				  <input id="MonthlyAmounts" class="form-control" name="MonthlyAmounts" value="{{old('MonthlyAmounts')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
					<label for="UsedPower">အသုံးပြုသည့်စွမ်းအင်</label>
	  				<input id="UsedPower" class="form-control" name="UsedPower" value="{{old('UsedPower')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  				...
	  				<input id="ProducedProduct" class="form-control" name="ProducedProduct" required="" value="{{old('ProducedProduct')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input id="ProducedOthers" class="form-control" name="ProducedOthers" value="{{old('ProducedOthers')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  				...
	  				<input id="RawMaterials" class="form-control" name="RawMaterials" value="{{old('RawMaterials')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input id="Goods" class="form-control" name="Goods" value="{{old('Goods')}}">
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					<label for="datepicker"><span style="color:red;">*</span> အလုပ်ရုံစတင်လုပ်ကိုင်သောရက်စွဲ</label>
		  			<input type="date" class="form-control" name="StartDate" id="datepicker" value="{{old('StartDate')}}">
	  			</div>
	  			<div class="col-sm-1">
	  				...
	  				<fieldset class="scheduler-border">
					    ...
					    <div class="control-group">
							 <div class="row">
								...
								<div class="col-sm-6">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="customRadio0"  type="radio" name="Contract" value=1 @if(old('Contract')=='1') checked @endif>
	  				...
	  				<fieldset class="scheduler-border">
					    ...
					    <div class="control-group">
						    <div class="row">
								...
								<div class="col-sm-6">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="overtime1"  type="radio" name="OverTime" value=1 @if(old('OverTime')=='1') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
								 <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="permission1"  type="radio" name="OTPermit" value=1 @if(old('OTPermit')=='1') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="customRadio2"  type="radio" name="NoticeStatus" value=1 @if(old('NoticeStatus')=='1') checked @endif>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="Workplace_safe1"  type="radio" name="SafteySide" value=1 @if(old('SafteySide')=='1') checked @endif>
						...
						<fieldset class="scheduler-border">
						  ...
						  <div class="control-group">
							  <div class="row">
								  ...
								  <div class="col-sm-6">
									  <div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="SafetyHealth1"  checked type="radio" name="SafetyHealth" value='မရှိ' @if(old('SafetyHealth')=='မရှိ') checked @endif >
	  		...
	  		<div class="row">
				<div class="col-sm-12">
		  		...
		  		<div class="row">
					  ...
					  <input id="max_min_salary" class="form-control" name="MinimumSalary" value="{{old('MinimumSalary')}}">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-center">
		  				...
		  				<input id="max_min_salary" class="form-control" name="MaximumSalary" value="{{old('MaximumSalary')}}">
		  			</div>
		  		</div>
		  		...
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
						  ...
						  {{-- <input  name="SalaryDate" id="datepicker" class="datepicker"> --}}
						  <select name="SalaryDate" id="SalaryDate" class="form-control">
							<option value="လကုန်ရက်" @if(old('SalaryDate')=='ညှိနှိုင်းရေးမှူး') selected @endif>လကုန်ရက်</option>
		       ...
		       <div class="row">
						    ...
						    <div class="control-group">
						    	<div class="row">
						    		...
						    		<div class="col-sm-4 text-right">
						    			 <input class="form-control" type="time" name="StartWorkTime" id="example-time-input" value="{{old('StartWorkTime')}}">
						    		</div>
						    	</div> <br>
						    	<div class="row">
						    		<div class="col-sm-4 text-center">
						    		...
						    		<div class="col-sm-4 text-right">
						    			 <input class="form-control" type="time" name="EndWorkTime" id="example-time-input" value="{{old('EndWorkTime')}}">
						    		</div>
						    	</div> <br>
						    	<div class="row">
						    		<div class="col-sm-4 text-center">
						    		...
						    		<div class="col-sm-4">
						    			<div class="row">
						    				<div class="col-sm-6">
						    					<label for="example-time-input">မှ</label>
						    					 <input class="form-control" type="time" name="freetimefrom" id="example-time-input" value="{{old('freetimefrom')}}">
						    				</div>
						    				<div class="col-sm-6">
						    					<label id="example-time-input">အထိ</label>
						    					<input class="form-control" type="time" name="freetimeto" id="example-time-input" value="{{old('freetimeto')}}"> 
						    				</div>
						         	...
						         	<div class="row">
						         		...
						         		<div class="col-sm-5">
										 <input  name="closeworkdays" id="closeworkdays" class="closeworkdays form-control" value="{{old('closeworkdays')}}">
						         		</div>
						         	</div>
		  		...
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
					    ...
					    <input id="signname" class="form-control" name="SignatureName" value="{{old('SignatureName')}}">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-center">
						...
						{{-- <input id="position" class="form-control" name="SignatureRank" value="{{old('SignatureRank')}}"> --}}
