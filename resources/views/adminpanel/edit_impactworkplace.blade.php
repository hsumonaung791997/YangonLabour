...
<form id="regForm" action="{{route('FactoryInspectionImpact.update',$id)}}" method="post">
        @csrf
        @method('PUT')
  	...
  	<div class="tab">
  		<p>	
  			<h3> {{$impact->casecondition=='သေဆုံး' ? 'သေဆုံးသူ ဆိုင်ရာအချက်အလက်များ' : 'ထိခိုက်သူ ဆိုင်ရာအချက်အလက်များ' }}</h3>
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					  <label for="dieworkername">{{$impact->casecondition=='သေဆုံး' ? 'သေဆုံးသူအမည်' : 'ထိခိုက်သူအမည်' }}</label>
                  <input id="dieworkername"  name="dieworkername" value="{{$impact->dieworkername}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
					<label for="occupation">အလုပ်အကိုင်</label>
	  				<input id="occupation"  name="occupation" value="{{$impact->occupation}}">
	  			</div>
	  		</div>
	  	</p>
	  	<p>	
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					  <label for="dieworkerage"> {{$impact->casecondition=='သေဆုံး' ? 'သေဆုံးသူအသက်' : 'ထိခိုက်သူအသက်' }}</label>
	  				<input id="dieworkerage"  name="dieworkerage" value="{{$impact->dieworkerage}}">
	  			</div>
	  			<div class="col-sm-1">

	  			</div>
	  			<div class="col-sm-6 text-center">
					<label for="dieworkerex"> {{$impact->casecondition=='သေဆုံး' ? 'သေဆုံးသူလုပ်သက်' : 'ထိခိုက်သူလုပ်သက်' }}</label>
	  				<input id="dieworkerex"  name="dieworkerex" value="{{$impact->dieworkerex}}">
	  			</div>
	  		</div>
	  	</p>
	  	<p>	
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  				<div class="row">
						...
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="female" checked="" type="radio" name="typeofsex" value="မ" {{$impact->typeofsex=='မ' ? 'checked' : ''}}>
	  	...
	  	<p>	
	  		<div class="row">
                  ...
                  <input  id="estimatedloss"  name="estimatedloss" value="{{$impact->estimatedloss}}">
	  			</div>
	  			<div class="col-sm-1">
                  ...
                  <input id="absentworkday"  name="absentworkday" value="{{$impact->absentworkday}}">
	  			</div>
	  		</div>
	  	</p>
	  	<p>
	  				...
	  				<fieldset class="scheduler-border">
					    ...
					    <div class="control-group">
							 <div class="row">
								...
								<div class="col-sm-6">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="returnwork1" checked="" type="radio" name="returnwork" value="မရှိ" {{$impact->returnwork=='မရှိ' ? 'checked' : ''}}>
							 ...
							 <div class="row">
							 	...
							 	<div class="col-sm-8">
                                 <input type="date" name="returnworkdate" id="returnworkdate" value="{{$impact->returnworkdate}}">
							 	</div>
							 </div>
					    </div>
					</fieldset>
	  				...
	  				<fieldset class="scheduler-border">
					    ...
					    <div class="control-group">
						    <div class="row">
								...
								<div class="col-sm-4 text-center">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="undermedical"  type="radio" name="injury" value="ဆေးကုသနေဆဲ" {{$impact->injury=='ဆေးကုသနေဆဲ' ? 'checked' : ''}}>
										<label class="custom-control-label" for="undermedical"> ဆေးကုသနေဆဲ</label>
									</div>
								</div>
								<div class="col-sm-4 text-left">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="retirehouse"  type="radio" name="injury" value="အိမ်တွင်းအနားယူနေဆဲ" {{$impact->injury=='အိမ်တွင်းအနားယူနေဆဲ' ? 'checked' : ''}}>
	  				...
	  				<fieldset class="scheduler-border"> <br>
					    <div class="control-group">
							 <div class="row">
								...
								<div class="col-sm-2 text-center">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="normalstate" type="radio" name="casecondition" value="သာမန်" {{$impact->casecondition=='သာမန်' ? 'checked' : ''}}>
										<label class="custom-control-label" for="normalstate">သာမန်အဆင့်</label>
									</div>
								</div>
								<div class="col-sm-2 text-center">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="severe"  type="radio" name="casecondition" value="အလွန်ပြင်းထန်" {{$impact->casecondition=='အလွန်ပြင်းထန်' ? 'checked' : ''}}>
										<label class="custom-control-label" for="severe">အလွန်ပြင်းထန်</label>
									</div>
								</div>
								<div class="col-sm-2 text-center">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="mortality"  type="radio" name="casecondition" value="သေဆုံး" {{$impact->casecondition=='သေဆုံး' ? 'checked' : ''}}>
										<label class="custom-control-label" for="mortality">သေဆုံးမှု</label>
									</div>
								</div>
								<div class="col-sm-2 text-center">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="denglevel"  type="radio" name="casecondition" value="ပြင်းထန်" {{$impact->casecondition=='ပြင်းထန်' ? 'checked' : ''}}>
	  				...
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
								...
								<div class="col-sm-2 text-center">
									<div class="custom-control custom-radio mb-3">
										<input  class="custom-control-input" id="coverage1"  type="radio" name="coverage" value="မရှိ" {{$impact->coverage=='မရှိ' ? 'checked' : ''}}>
	  	...
	  	<p>
	  				...
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
                                 ...
                                 <input  id="damageoccur"  name="damageoccur" value="{{$impact->damageoccur}}">
								</div>
								<div class="col-sm-1">
								...
								<div class="col-sm-7">
									<div class="row">
                                        ...
                                        <input type="date" name="occurdate" id="occurdate" value="{{$impact->occurdate}}">
										</div>
										<div class="col-sm-6">
											<label for="occurtime">ဖြစ်ပွားခဲ့သည့်အချိန်</label>
                                        <input type="time" name="occurtime" id="occurtime" value="{{$impact->occurtime}}">
										</div>
									</div>
								</div>
							 </div> <br>
	  		...
	  		<p>	
		  		<div class="row">
                      ...
                      <input  type="date"  name="receivenoti"  id="receivenoti" value="{{$impact->receivenoti}}">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				<div class="row">
                            ...
                            <input type="datetime-local" name="inspectiondate" id="inspectiondate" value="{{$impact->inspectiondate}}">
							</div>
							{{-- <div class="col-sm-4">
	  		...
	  		<p>	
		  		<div class="row">
                      ...
                      <input id="check" name="check" value="{{$impact->check}}">
		  			</div>
		  			<div class="col-sm-1">
                      ...
                      <input id="name"  name="checkName" value="{{$impact->checkName}}">
		  			</div>
		  		</div>
			  </p>
			  <p>	
					<div class="row">
                        ...
                        <input id="position"  name="checkPosition" value="{{$impact->checkPosition}}">
						</div>
						<div class="col-sm-1">
	  			...
	  			<div class="col-sm-12">
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
							 	<div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" placeholder="ထိခိုက်မှုဖြစ်ပွားပုံအကျဉ်း" id="injurybrief" name="injurybrief">{{$impact->injurybrief}}</textarea>
								</div>
							 </div>
					    </div>
					</fieldset>
	  			...
	  			<div class="col-sm-12">
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
							 	<div class="col-sm-12"> 
                                 <textarea class="col-sm-12" rows="5" placeholder="လုပ်ငန်းခွင်ထိခိုက်မှု ဖြစ်စဉ် အပြည့်အစုံ ရေးသားရန်" id="fullprocess" name="fullprocess">{{$impact->fullprocess}}</textarea>
								</div>
							 </div>
					    </div>
					</fieldset>
	  			...
	  			<div class="col-sm-12">
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
							 	<div class="col-sm-12"> 
                                 <textarea class="col-sm-12" rows="5" placeholder="ထိခိုက်မှုဖြစ်ပွားရသည့် နောက်ကွယ် အကြောင်းရင်း(Underlying Causes)" id="underlyingcauses" name="underlyingcauses">{{$impact->underlyingcauses}}</textarea>
								</div>
							 </div>
					    </div>
					</fieldset>
  	...
  	<div class="tab">
	  			...
	  			<div class="col-sm-12">
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
							 	<div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" placeholder="ထိခိုက်မှုဖြစ်ပွားရသည့် အခြေခံ အကြောင်းရင်း(Basic/Root Causes)" id="basiccauses" name="basiccauses">{{$impact->basiccauses}}</textarea>
								</div>
							 </div>
					    </div>
					</fieldset>
	  			...
	  			<div class="col-sm-12">
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
							 	<div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" placeholder="သုံးသပ်ချက်" id="review" name="review">{{$impact->review}}</textarea>
								</div>
							 </div>
					    </div>
					</fieldset>
	  				...
	  				<fieldset class="scheduler-border"> 
					    ...
					    <div class="control-group">
							 <div class="row">
							 	<div class="col-sm-6"> 
	  								<p>
                                      <input placeholder="အမည်"  name="witnessname1" value="{{$impact->witnessname1}}"> 
									</p>
                                <p><input placeholder="ရာထူး"  name="witnessposition1" value="{{$impact->witnessposition1}}"></p>
								</div>
								<div class="col-sm-6"> 
                                <p><input placeholder="အမည်"  name="witnessname2" value="{{$impact->witnessname2}}"> </p>
                                <p><input placeholder="ရာထူး"  name="witnessposition2" value="{{$impact->witnessposition2}}"></p>
								</div>
							 </div>
							 <div class="row">
							 	<div class="col-sm-6"> 
                                 <p><input placeholder="ပိုင်ရှင်အမည်"  name="witnessownername" value="{{$impact->witnessownername}}"> </p>
	  								
								</div>
								<div class="col-sm-6"> 
                                <p><input placeholder="မန်နေဂျာအမည်"  name="witnessmanagername" value="{{$impact->witnessmanagername}}"></p>
								</div>
							 </div>
					    </div>
					</fieldset>
	  	...
	  	<p>	
	  		<div class="row">
				  ...
				  <div class="col-sm-4">
                  <input  type="text" id="inspector"  name="inspector" value="{{$impact->inspector}}">
				  </div>
	  			<!-- <div class="col-sm-1">
