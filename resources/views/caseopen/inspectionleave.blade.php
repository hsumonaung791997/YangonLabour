...
<p>
    <div class="row">
		...
		<div class="col-sm-6 text-left">
			၆။ လုပ်ငန်းအမျိုးအစား - {{$factory->WorkTypeId}}
		</div>
	</div>
</p>
<p>
    <div class="row">
		<div class="col-sm-6">
			၇။ ရင်းနှီးမြှုပ်နှံမှု (LDI/FDI) - <!-- {{$factory->UsedPower}} -->
		</div>
		<div class="col-sm-6 text-left">
...
<p>
    <div class="row">
		...
		<div class="col-sm-6 text-left">
			၂၇။ သက်သာချောင်ချိရေး ဆောင်ရွက်မှုကိစ္စ - @if($factory->SafteySide == 0) ရှိ @else မရှိ @endif
		</div>
	</div>
</p>
<p>
