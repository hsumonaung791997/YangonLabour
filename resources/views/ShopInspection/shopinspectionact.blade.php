...
@endif
	...
	<form id="regForm"class="form-background" action="{{ route('ShopSafteyInspection.store')}}" method="post">
	 {{csrf_field()}}
		...
		{{-- township Id  --}}
			<input type="hidden" id="township_id" name="township_id" value="{{old('township_id')}}">
		{{--  --}}
		...
		{{-- <p>
				<div class="row">
						<div class="col-sm-6">
							<select name="inspection_type">
								<option value='ပထမအကြိမ်' @if(old('inspection_type')=='ပထမအကြိမ်') selected @endif>ပထမအကြိမ်</option>
								<option value='ထပ်မံ' @if(old('inspection_type')=='ထပ်မံ') selected @endif>ထပ်မံ</option>
								<option value='တိုင်ကြားစာအရ' @if(old('inspection_type')=='တိုင်ကြားစာအရ') selected @endif>တိုင်ကြားစာအရ</option>
							</select>
						</div>
						<div class="col-sm-6">		
								<label for="datepicker">စစ်ဆေးခဲ့သည့်နေ့စွဲနှင့်အချိန်</label>					
								<input type='datetime-local' id="inspection_datetime" name="inspection_datetime" value={{old('inspection_datetime')}}/>
						</div>
	  		...
	  		<!-- <div class="row">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input name="shopregion" id="ShopAddress" class="form-control" value="{{old('shopregion')}}">
	  			</div>
	  		</div>
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  				...
	  				<input id="shopOwnerNrc" class="form-control" name="shopOwnerNrc" value="{{old('shopOwnerNrc')}}">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input id="shopOwnerAddress" class="form-control" name="shopOwnerAddress" value="{{old('shopOwnerAddress')}}">
	  			</div>
	  		</div>
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="ကျား" class="form-control" name="menworker" value="{{old('menworker')}}" id="menworker" onkeyup="converunistring()"/>
									</div>
									<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="မ" class="form-control" name="womenworker"  value="{{old('womenworker')}}" id="womenworker" onkeyup="converunistring()"/>
									</div>
									<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="စုစုပေါင်း" class="form-control" name="totalworker" value="{{old('totalworker')}}" id="totalworker">
									</div>
								</div>
							</div>
						</fieldset> 
			...
			<p>
				<div class="row">				
		  			<div class="col-sm-6 text-center">
							...
							<div class="control-group">
								<div class="row">
								<textarea class="col-sm-12 form-control" name="sittingplan" rows="5" placeholder="တွေ့ရှိချက်">{{old('sittingplan')}}</textarea>
								</div>
							</div>
						</fieldset>
		  			</div>
		...
		<p><textarea class='col-sm-12 form-control' name="change5" rows="3">{{old('change5')}}</textarea></p>
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<input type="text" name="inspectorname" id="inspectorname" class="form-control" value="{{old('inspectorname')}}" required/>
					
				</div>
				<div class="col-sm-4">
					<label for="inspectorrank">စစ်ဆေးသူအရာရှိ ရာထူး <span style="color:red">*</span></label>
					<input type="text" name="inspectorrank" id="inspectorrank" class="form-control" value="{{old('inspectorrank')}}" required/>
				</div>
			</div>
