...
<form id="shopinspect" action="{{url('Edit_Shop_LabourInspectionLaw/'.$shop_labour_law->id)}}" method="post">
	 {{csrf_field()}}
							    ...
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="numholidays" name="numholidays" type="radio" value="ရှိ" {{$shop_labour_law->numholidays=='ရှိ' ? 'checked' : ''}}>
										  <label class="custom-control-label" for="numholidays">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="numholidays1" type="radio" name="numholidays" value="မရှိ" {{$shop_labour_law->numholidays=='မရှိ' ? 'checked' : ''}}>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="opportunityhol" name="opportunityhol" type="radio" value="ပြု" {{$shop_labour_law->opportunityhol=='ပြု' ? 'checked' : ''}}>
										  <label class="custom-control-label" for="opportunityhol">ပြု</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="opportunityhol1" type="radio" name="opportunityhol" value="မပြု" {{$shop_labour_law->opportunityhol=='မပြု' ? 'checked' : ''}}>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="paidwage" name="paidwage" type="radio" value="ရှိ" {{$shop_labour_law->paidwage=='ရှိ' ? 'checked' : ''}}>
										  <label class="custom-control-label" for="paidwage">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="paidwage1" type="radio" name="paidwage" value="မရှိ"  {{$shop_labour_law->paidwage=='မရှိ' ? 'checked' : ''}} >
			...
			<legend class="scheduler-border">လုပ်သက်ခွင့်ရက်ကို နှစ်စဉ် ခံစားခွင့်  </legend>
				<div class="control-group">
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays" name="vacationdays" type="radio" value="ပေး" {{$shop_labour_law->vacationdays=='ပေး' ? 'checked' : ''}}>
								<label class="custom-control-label" for="vacationdays">ပေး </label>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays1" type="radio" name="vacationdays" value="မပေး" {{$shop_labour_law->vacationdays=='မပေး' ? 'checked' : ''}}>
			...
			<legend class="scheduler-border">အလုပ်မှ နုတ်ထွက် ထုတ်ပြစ်သော လုပ်သားများအား ခွင့်ရက်အစား အခကြေးငွေကို ရှင်းပေးခြင်း</legend>
				<div class="control-group">
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees" name="workerfrees" type="radio" value="ရှိ" {{$shop_labour_law->workerfrees=='ရှိ' ? 'checked' : ''}}>
								<label class="custom-control-label" for="workerfrees">ရှိ </label>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees1" type="radio" name="workerfrees" value="မရှိ" {{$shop_labour_law->workerfrees=='မရှိ' ? 'checked' : ''}}>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="annual" name="annual" type="radio" value="ရှိ" {{$shop_labour_law->annual=='ရှိ' ? 'checked' : ''}}>
										  <label class="custom-control-label" for="annual">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="annual1" type="radio" name="annual" value="မရှိ" {{$shop_labour_law->annual=='မရှိ' ? 'checked' : ''}}>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="contract" name="contract" type="radio" value="ရှိ" {{$shop_labour_law->contract=='ရှိ' ? 'checked' : ''}}>
										  <label class="custom-control-label" for="contract">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="contract1" type="radio" name="contract" value="မရှိ" {{$shop_labour_law->contract=='မရှိ' ? 'checked' : ''}}>
  				...
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-6 text-center">
								 		<div class="custom-control custom-radio mb-3">
										  <input  class="custom-control-input" id="registrationbook" name="registrationbook" type="radio" value="ရှိ" {{$shop_labour_law->registrationbook=='ရှိ' ? 'checked' : ''}}>
										  <label class="custom-control-label" for="registrationbook">ရှိ </label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="registrationbook1" type="radio" name="registrationbook" value="မရှိ" {{$shop_labour_law->registrationbook=='မရှိ' ? 'checked' : ''}}>
  		...
  		<div class="col-sm-6">
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-12">
								 		<input type="text" class="form-control" name="medicalticketqan" value="{{$shop_labour_law->medicalticketqan}}"/>
								 	</div>
								 </div>
						    </div>
				</fieldset>
...
<div class="tab">
	...
	<div class="row">
		<div class="col-sm-6 text-center">
		  	<textarea class="col-sm-12 form-control" rows="4" placeholder="ယခင်က ပြစ်မှုထင်ရှား စီရင်ခြင်း ခံရလျှင် အဆိုပါ အကြောင်းအရာများကို ဖော်ပြရန်" id="letter" name="passionremark">{{$shop_labour_law->passionremark}}</textarea>		
		  			
		</div>
		<div class="col-sm-6 text-center">
		  	<textarea class="col-sm-12 form-control" rows="4" placeholder="အထွေထွေမှတ်ချက်များ" id="letter" name="generalremark">{{$shop_labour_law->generalremark}}</textarea>		
	...
	<div class="row">
		<div class="col-sm-12 text-center">
		  	<textarea class="col-sm-12 form-control" rows="4" placeholder="အထက်အရာရှိမှတ်ချက်" id="letter" name="officeremark">{{$shop_labour_law->officeremark}}</textarea>		
    ...
    <h3 class="text-center text-primary">၂၀၁၆ ခုနှစ် ဆိုင်များနှင့်အလုပ်ဌာနများ အက်ဥပေဒေ</h3>
            ...
            <div class="row">
               <div class="col-sm-12">
                    ...
                    <textarea rows="4" class="col-sm-12 form-control" name="work_duration" id="workduration">{{$shop_labour_law->work_duration}}   
                    </textarea>
                </div>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                 <div class="row">
                                    <div class="col-sm-6 text-center">
                                        <div class="custom-control custom-radio mb-3">
                                          <input class="custom-control-input" id="worktimenotice" name="worktime_notice" type="radio" value="ပြု" {{$shop_labour_law->worktime_notice=='ပြု' ? 'checked' : ''}}>
                                          <label class="custom-control-label" for="worktimenotice">ပြု</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="worktimenotice1" type="radio" name="worktime_notice" value="မပြု" {{$shop_labour_law->worktime_notice=='မပြု' ? 'checked' : ''}}>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6 text-center">
                                        <div class="custom-control custom-radio mb-3">
                                          <input  class="custom-control-input" id="SSB" name="SSB" type="radio" value="ထား" {{$shop_labour_law->SSB=='ထား' ? 'checked' : ''}}>
                                          <label class="custom-control-label" for="SSB">ထား</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="SSB1" type="radio" name="SSB" value="မထား" {{$shop_labour_law->SSB=='မထား' ? 'checked' : ''}}>
                ...
                <div class="row">               
                    <div class="col-sm-5 text-center">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6 text-center">
                                        <div class="custom-control custom-radio mb-3">
                                          <input  class="custom-control-input" id="salarytime" name="salary_time" type="radio" value="ပေး" {{$shop_labour_law->salary_time=='ပေး' ? 'checked' : ''}}>
                                          <label class="custom-control-label" for="salarytime">ပေး</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="salarytime1" type="radio" name="salary_time" value="မပေး" {{$shop_labour_law->salary_time=='မပေး' ? 'checked' : ''}}>
                    ...
                    <div class="col-sm-6 text-center">
                      <label for="weekendholiday">ရက်သတ္တပတ်ပိတ်ရက်</label>
                        <input type="text" id='weekendholiday' class="form-control" name="weekend_holiday" value="{{$shop_labour_law->weekend_holiday}}"/>
                    </div>
                </div>
	<div class="row">
		...
		<div class="col-sm-5 text-center">
		  		<input type="text" name="inspectionname" id="inspectionname" class="form-control" value="{{$shop_labour_law->inspectionname}}">	
