...
<form id="inspectform" class="form-background" action="{{route('FactoryInspectionWage.store')}}"  method="post">
  ...
  <div class="row">
          ...
          <div class="col-sm-6 text-left">
            ...
            <input id="OTpaymentplan"  name="OTpaymentplan">
          </div>
  </div>
    <p>
    <fieldset class="scheduler-border">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-12">             
                        <div class="row">
                          <div class="col-sm-6">
                            <input type="text"placeholder="အနည်းဆုံး" name="miniexperprize"/>
                          </div>
                          <div class="col-sm-6">
                            <input type="text"placeholder="အများဆုံး" name="maxexperprize"/>
                          </div>
                        </div>
                      </div>
                    </div>          
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-12">             
                        <div class="row">
                          <div class="col-sm-6">
                            <input type="text"placeholder="အနည်းဆုံး" name="miniregularprize"/>
                          </div>
                          <div class="col-sm-6">
                            <input type="text"placeholder="အများဆုံး" name="maxregularprizee"/>
                          </div>
                        </div>
                      </div>
                    </div>          
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-4">              
                        <input type="text"placeholder="အနည်းဆုံး" name="miniproductprize"/>
                      </div>
                      <div class="col-md-4">              
                        <input type="text"placeholder="အများဆုံး" name="maxproductprize"/>
                      </div>
                    </div>          
                  </div>
      ...
      <p>
        <div class="row">
                   ...
                   <div class="row">
                    <div class="col-sm-6 text-center">
                      <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" id="fine" name="fine" type="radio" value=0>
                        <label class="custom-control-label" for="fine">ရှိ</label>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="custom-control custom-radio mb-3">
                        <input  class="custom-control-input" id="fine1" checked="" type="radio" name="fine" value=1>
          ...
          <div class="col-sm-6 text-left">
              ...
              <input  name="deductamount" id="deductamount">
          </div>
        </div>
      </p>
  <p>
            ...
            <div class="col-sm-12 text-center">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text"placeholder="ကာလ" name="illegaldeductedtime"/>
                  </div>
              ...
              <div class="col-sm-4">
                  <div class="form-group">
                    <input type="text"placeholder="လုပ်သားအရေအတွက်" name="illegaldeductedworkers"/>
                  </div>
                              
              </div>
              <div class="col-sm-4">
                  <div class="form-group">
                    <input type="text"placeholder="သင့်ငွေ" name="illegaldedutedamount"/>
          ...
          <legend class="scheduler-border">လုပ်ခပေးချေခြင်း မှတ်တမ်း</legend>
            <div class="control-group">
                 <div class="row">
                  <div class="col-sm-6 text-center">
                    <div class="custom-control custom-radio mb-3">
                      <input class="custom-control-input" id="customRadio" name="paymentnote" value=0 type="radio">
                      <label class="custom-control-label" for="customRadio">ရှိ</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="customRadio0" checked="" value=1 type="radio" name="paymentnote">
            ...
            <div class="col-sm-6 text-center">
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                  ...
                  <div class="col-sm-6 text-center">
                    <div class="custom-control custom-radio mb-3">
                      <input class="custom-control-input" id="deductednote" name="deductednote" value=0 type="radio">
                      <label class="custom-control-label" for="deductednote">ရှိ</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="deductednote1" checked="" value=1 type="radio" name="deductednote">
      ...
      <div class="col-sm-5 text-center">
        <fieldset class="scheduler-border">
          ...
          <div class="control-group">
            ...
            <div class="col-sm-6 text-center">
              <div class="custom-control custom-radio mb-3">
                <input class="custom-control-input" id="allowotnote" name="allowotnote" value=0 type="radio">
                <label class="custom-control-label" for="allowotnote">ရှိ</label>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="custom-control custom-radio mb-3">
                <input  class="custom-control-input" id="allowotnote1" checked="" value=1 type="radio" name="allowotnote">
      ...
      <div class="col-sm-12 text-center">
        <fieldset class="scheduler-border">
          ...
          <div class="control-group">
           ...
           <div class="row">
              <div class="col-sm-12 text-center">
                 <textarea class="col-sm-12" rows="4" placeholder="ညွှန်ကြားရန်အချက် (ခ)" name="instruction1"></textarea>
              </div>
           </div>
           <div class="row">
              <div class="col-sm-12 text-center">
                 <textarea class="col-sm-12" rows="4" placeholder="ညွှန်ကြားရန်အချက် (ဂ)" name="instruction1"></textarea>
              </div>
           </div>
          </div>
      </fieldset>
