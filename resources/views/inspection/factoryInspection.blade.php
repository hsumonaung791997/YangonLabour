...
$('#datepicker1').datepicker({
    ...
    <input type="hidden" id="factoryid" name="factory_id"  value="{{old('factory_id')}}">
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <select name='inspectedtimes' id="testingtime" class="form-control">
                                <option value='ပထမအကြိမ်' @if(old('inspectedtimes')=='ပထမအကြိမ်') selected @endif>ပထမအကြိမ်</option>
                                <option value='ဒုတိယအကြိမ်' @if(old('inspectedtimes')=='ဒုတိယအကြိမ်') selected @endif>ဒုတိယအကြိမ်</option>
                                <option value='တတိယအကြိမ်' @if(old('inspectedtimes')=='တတိယအကြိမ်') selected @endif>တတိယအကြိမ်</option>
                                <option value='စတုတ္ထအကြိမ်' @if(old('inspectedtimes')=='စတုတ္ထအကြိမ်') selected @endif>စတုတ္ထအကြိမ်</option>
                                <option value='ပဉ္စမအကြိမ်' @if(old('inspectedtimes')=='ပဉ္စမအကြိမ်') selected @endif>ပဉ္စမအကြိမ်</option>
                                <option value='ဆဌမအကြိမ်' @if(old('inspectedtimes')=='ဆဌမအကြိမ်') selected @endif>ဆဌမအကြိမ်</option>
                                <option value='သတ္တမအကြိမ်' @if(old('inspectedtimes')=='သတ္တမအကြိမ်') selected @endif>သတ္တမအကြိမ်</option>
                                <option value='အဌမအကြိမ်' @if(old('inspectedtimes')=='အဌမအကြိမ်') selected @endif>အဌမအကြိမ်</option>
                                <option value='နဝမအကြိမ်' @if(old('inspectedtimes')=='နဝမအကြိမ်') selected @endif>နဝမအကြိမ်</option>
                                <option value='ဒဿမအကြိမ်'@if(old('inspectedtimes')=='ဒဿမအကြိမ်') selected @endif>ဒဿမအကြိမ်</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <select name='inspectiontype' id="testingtime" class="form-control">
                                <option value='ပုံမှန်' @if(old('inspectiontype')=='ပုံမှန်') selected @endif>ပုံမှန်</option>
                                <option value='ပြန်လည်' @if(old('inspectiontype')=='ပြန်လည်') selected @endif>ပြန်လည်</option>
                                <option value='တုံ့ပြန်' @if(old('inspectiontype')=='တုံ့ပြန်') selected @endif>တုံ့ပြန်</option>
                                <option value='အထူး' @if(old('inspectiontype')=='အထူး') selected @endif>အထူး</option>
                                <option value='လျှပ်တစ်ပြတ်' @if(old('inspectiontype')=='လျှပ်တစ်ပြတ်') selected @endif>လျှပ်တစ်ပြတ်</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                        <input type="date" name="inspectiondate" id="inspectiondate" class="form-control" value="{{old('inspectiondate')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input type="date" name="lastinspectiondate" id="lastinspectiondate" class="form-control" value="{{old('lastinspectiondate')}}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input  name="workerownername" id="BusinessOwnerName" class="form-control" value="{{old('workerownername')}}">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input name="workerowneraddress" id="BusinessOwnerAddress" class="form-control" value="{{old('workerowneraddress')}}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input name="ownername" id="OwnerName" class="form-control" value="{{old('ownername')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="owneraddress" id="OwnerAddress" class="form-control" value="{{old('owneraddress')}}">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="registerownername" id="namebyrecord" class="form-control" value="{{old('registerownername')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="workertotal" id="WorkedPower" class="form-control" value="{{old('workertotal')}}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="managername" id="ManagerName" class="form-control" value="{{old('managername')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input name="manageraddress" id="ManagerAddress" class="form-control" value="{{old('manageraddress')}}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="intervieweename" id="AccountableName" class="form-control" value="{{old('intervieweename')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input  name="intervieweerank" id="AccountableRank" class="form-control" value="{{old('intervieweerank')}}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="machinetype" id="typeofencourage" class="form-control" value="{{old('machinetype')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input   name="horsepower" id="Horsepower" class="form-control" value="{{old('horsepower')}}">
                        </div>
                    </div>
                </div>
            </div>
...
"> ထုတ်လုပ်သော ပစ္စည်းအများအစား</label>
                        ...
                        <div class="col-sm-7">
                            <input   name="producttype" id="ProductProperty" class="form-control" value="{{old('producttype')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input name="productquantity" id="MonthlyAmounts" class="form-control" value="{{old('productquantity')}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-12 text-center">
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <textarea class="col-sm-12 form-control" rows="4"   name="factoryaddress" id="factoryaddress">{{old('factoryaddress')}}</textarea>
                                    </div>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="ServiceOpen1" type="radio" name="jobopen" value=1 @if(old('jobopen')=='1') checked @endif>
                                    ...
                                    <div class="col-sm-5 text-center">
                                    <input type="date" name="closeddate" id="datepicker" class="datepicker form-control" value="{{old('closeddate')}}">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                             <input name="inspection_name" id="inspection_name" class="form-control" value="{{old('inspection_name')}}"> 
                ...
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                             <input name="inspectorrank" id="inspectorrank" class="form-control" value="{{old('inspectorrank')}}"> 
                        </div>
                    </div>
                </div>
            </div>
