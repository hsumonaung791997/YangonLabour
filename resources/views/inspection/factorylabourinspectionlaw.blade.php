                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="sentnotice1"  type="radio" name="sentnotice" value='မပြု' @if(old('shownotice')=='မပြု') checked @endif>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="shownotice1"  type="radio" name="shownotice" value='မပြု' @if(old('shownotice')=='မပြု') checked @endif>
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <input type="date" placeholder="နေ့စွဲ" name="workingduration" class="form-control" value="{{old('workingduration')}}" id="datepicker">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="repeatitivework1"  type="radio" name="repeatitivework" value='မရှိ' @if(old('repeatitivework')=='မရှိ') checked @endif>
                    ...
                    <div class="col-sm-5 text-center">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="changenotice1"  type="radio" name="changenotice" value='မရှိ' @if(old('changenotice')=='မရှိ') checked @endif>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="informchangenotice1"  type="radio" name="informchangenotice" value='မကြား' @if(old('informchangenotice')=='မကြား') checked @endif>
                            ...
                            <div class="control-group">
                                <div class="row">
                                 <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="equalnotice1" type="radio" name="equalnotice" value='မလုပ်' @if(old('equalnotice')=='မပြု') checked @endif>
                                 ...
                                 <div class="col-sm-4">
                                    ...
                                    <input name="dailyworktime" id="dailyworktime" class="form-control" value="{{old('dailyworktime')}}">
                                 </div>
                                 <div class="col-sm-4">
                                     <label for="weeklyworktime"> ရက်သတ္တပတ်</label>
                                    <input   name="weeklyworktime" id="weeklyworktime" class="form-control" value="{{old('weeklyworktime')}}">
                                 </div>
                                 </div> <br>
                                 <div class='row'><div class="col-sm-4">
                                     <label for="resttime"> အနားပေးချိန်</label>
                                    <input id="resttime"  name="resttime" class="form-control" value="{{old('resttime')}} ">
                                 </div>
                                 <div class="col-sm-4">
                                     <label for="weekendholiday">ရက်သတ္တပတ်ပိတ်ရက်</label>
                                    <input id="weekendholiday" name="weekendholiday" class="form-control" value="{{old('weekendholiday')}}">
                                 </div>
                ...
                <fieldset class="scheduler-border">
                        ...
                        <div class="control-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="custom-control custom-radio mb-3">
                                        <input  class="custom-control-input" id="insteadrelaxdays1" type="radio" name="insteadrelaxdays" value='မရှိ' @if(old('insteadrelaxdays')=='မရှိ') checked @endif  >
                                ...
                                <div class="row">
                                        ...
                                        <fieldset class="scheduler-border">
                                                ...
                                                <div class="control-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="custom-control custom-radio mb-3">
                                                                <input  class="custom-control-input" id="prepermit1" type="radio" name="prepermit" value='မရှိ' @if(old('prepermit')=='မရှိ') checked @endif>
                                        ...
                                        <fieldset class="scheduler-border">
                                                ...
                                                <div class="control-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="custom-control custom-radio mb-3">
                                                                <input  class="custom-control-input" id="workwithpermit1" type="radio" name="workwithpermit" value='မရှိ' @if(old('workwithpermit')=='မရှိ') checked @endif>
                                 ...
                                 <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="otpayscale" class="form-control" name="otpayscale" value="{{old('otpayscale')}}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="diffrentotpayment"> အချိန်ပိုလုပ်ခခြားနားငွေ</label>
                                             <input id="diffrentotpayment" class="form-control" name="diffrentotpayment" value="{{old('diffrentotpayment')}}">
                                        </div>
                                 </div> <br>
                                 <div class="row">
                                     <div class="col-sm-6">
                                        <fieldset class="scheduler-border">
                                                ...
                                                <div class="control-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="custom-control custom-radio mb-3">
                                                                <input  class="custom-control-input" id="allowtimecalculate1" type="radio" name="allowtimecalculate" value='မရှိ' @if(old('allowtimecalculate')=='မရှိ') checked @endif>
                            ...
                            <div class="control-group">
                                <div class="row">
                                 <div class="col-sm-6">
                                    ...
                                    <input id="illegalotallow" class="form-control" name="illegalotallow" value="{{old('illegalotallow')}}">
                                 </div>                             
                                 <div class="col-sm-6">
                                     <label for="illegalottime">လုပ်ကိုင်မှုအခြေအနေ(ကာလ၊နေ့စဉ်/အပတ်စဉ်-နာရီ)</label>
                                    <input id="illegalottime" class="form-control" name="illegalottime" value="{{old('illegalotime')}}">
                                 </div>                              
                                 </div>
                            </div>
                            ...
                            <div class="control-group">
                                <div class="row">
                                 <div class="col-sm-6">
                                    ...
                                    <input id="illegalotpayment" class="form-control" name="illegalotpayment" value="{{old('illegalopayment')}}">
                                 </div>
                                 <div class="col-sm-6">
                                    <fieldset class="scheduler-border">
                                            ...
                                            <div class="control-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="custom-control custom-radio mb-3">
                                                            <input  class="custom-control-input" id="twofacbyday1" type="radio" name="twofacbyday" value='မရှိ' @if(old('twofacbyday')=='မရှိ') checked @endif>
                                    ...
                                    <fieldset class="scheduler-border">
                                            ...
                                            <div class="control-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="custom-control custom-radio mb-3">
                                                            <input  class="custom-control-input" id="definedworktime1" type="radio" name="definedworktime" value='မရှိ' @if(old('definedworktime')=='မရှိ') checked @endif>
                                    ...
                                    <fieldset class="scheduler-border">
                                            ...
                                            <div class="control-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="custom-control custom-radio mb-3">
                                                            <input  class="custom-control-input" id="stosworktime1" type="radio" name="stosworktime" value='မရှိ' @if(old('stosworktime')=='မရှိ') checked @endif>
                            ...
                            <div class="control-group">
                                 <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input id="washcategory" class="form-control" name="washcategory" value="{{old('washcategory')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="custom-control custom-radio mb-3">
                                            <label for="washamount"> အရေအတွက်</label>
                                            <input id="washamount" class="form-control" name="washamount" value="{{old('washamount')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="washusestate1"  type="radio" name="washusestate" value='မကောင်း' @if(old('washusestate')=='မကောင်း') checked @endif>
                            ...
                            <div class="control-group">
                                 <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input id="sitcategory" class="form-control" name="sitcategory" value="{{old('sitcategory')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="custom-control custom-radio mb-3">
                                            <label for="sitamount">အရေအတွက် </label>
                                            <input id="sitamount" class="form-control" name="sitamount" value="{{old('sitamount')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class='row'><label class="col-sm-12 text-center">အသုံးပြုနိုင်မှုအခြေအနေ</label></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="situsestate1"  type="radio" name="situsestate" value='မကောင်း' @if(old('situsestate')=='မကောင်း') checked @endif>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="babysittingroom1"  type="radio" name="babysittingroom" value='မရှိ' @if(old('babysittingroom')=='မရှိ') checked @endif>
                        ...
                        <fieldset class="scheduler-border">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input  class="custom-control-input" id="dinningroom1"  type="radio" name="dinningroom" value='မရှိ' @if(old('dinningroom')=='မရှိ') checked @endif>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="control-group">
                                        ...
                                        <input id="waterplace" class="form-control" name="waterplace" value="{{old('waterplace')}}">
                                    </div>
                                </div>
                                    <div class="col-sm-6">
                                        <div class="control-group">
                                            <label for="watercleanence"> သောက်ရေသန့်ရှင်းမှု</label>
                                            <input id="watercleanence" class="form-control" name="watercleanence" value="{{old('watercleanence')}}">
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="suffientamount1"  type="radio" name="suffientamount" value='မရှိ' @if(old('suffientamount')=='မရှိ') checked @endif>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="cooling1"  type="radio" name="cooling" value='မရှိ' @if(old('cooling')=='မရှိ') checked @endif>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="control-group">
                                        ...
                                        <input id="tioletcategroy" class="form-control" name="tioletcategroy" value="{{old('tioletcategroy')}}">
                                    </div>
                                </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="tioletplace1"  type="radio" name="tioletplace" value='မရှိ' @if(old('tioletplace')=='မရှိ') checked @endif>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="tioletclean1"  type="radio" name="tioletclean" value='မရှိ' @if(old('tioletclean')=='မရှိ') checked @endif>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="genderdivide1"  type="radio" name="genderdivide" value='မရှိ' @if(old('genderdivide')=='မရှိ') checked @endif>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" id="mtioletroom" class="form-control" name="mtioletroom" value="{{old('mtioletroom')}}"/>
                                            </div>
                                    <div class="col-sm-4">
                                        <label for="ftioletroom"> မအိမ်သာ</label>
                                        <input type="text" id="ftioletroom" class="form-control" name="ftioletroom" value="{{old('ftioletroom')}}" />
                                    </div>
                                 </div>
                            </div>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row">
                                <div class="col-sm-6 text-center">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="accidentcase1"  type="radio" name="accidentcase" value='မရှိ' @if(old('accidentcase')=='မရှိ') checked @endif>
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="control-group">
                                     <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input  class="custom-control-input" id="workerregistrationbook1"  type="radio" name="workerregistrationbook" value='မရှိ' @if(old('workerregistrationbook')=='မရှိ') checked @endif>
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input  class="custom-control-input" id="childregistrationbook1" type="radio" name="childregistrationbook" value='မရှိ' @if(old('childregistrationbook')=='မရှိ') checked @endif>
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="control-group">
                                     <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input  class="custom-control-input" id="generalbook1" type="radio" name="generalbook" value='မရှိ' @if(old('generalbook')=='မရှိ') checked @endif>
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input  class="custom-control-input" id="wokerofficetimebook1" type="radio" name="wokerofficetimebook" value='မရှိ' @if(old('wokerofficetimebook')=='မရှိ') checked @endif>
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="control-group">
                                     <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input  class="custom-control-input" id="otbook1" type="radio" name="otbook" value='မရှိ' @if(old('otbook')=='မရှိ') checked @endif>
              ...
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                 <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="causal1"  type="radio" name="causalleave" value='မပေး' @if(old('causalleave')=='မပေး') checked @endif>
            ...
            <div class="col-sm-6 text-center">
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="SSB1"  type="radio" name="annualleave" value='မပေး' @if(old('annualleave')=='မပေး') checked @endif>
              ...
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                 <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="medicalleave1"  type="radio" name="medicalleave" value='မပေး' @if(old('medicalleave')=='မပေး') checked @endif>
            ...
            <div class="col-sm-6 text-center">
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="maternityleave1"  type="radio" name="maternity" value='မပေး' @if(old('maternity')=='မပေး') checked @endif>
              ...
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                 <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="publicholiday1"  type="radio" name="publicholiday" value='မပေး' @if(old('publicholiday')=='မပေး') checked @endif>
            ...
            <div class="col-sm-6 text-center">
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="weekendholiday1"  type="radio" name="weekholiday" value='မပေး' @if(old('weekholiday')=='မပေး') checked @endif>
              ...
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                 <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="leavenote1"  type="radio" name="leavenote" value='မထား' @if(old('leavenote')=='မထား') checked @endif>
          ...
          <fieldset class="scheduler-border">
            ...
            <div class="row">
                <div class="col-sm-5 text-center">
                  ...
                  <input id="OTplan" class="form-control" name="OTplan" value="{{old('OTplan')}}">
                </div>
                <div class="col-sm-1">
                ...
                <div class="col-sm-6 text-left">
                  ...
                  <input id="OTpaymentplan" class="form-control" name="OTpaymentplan" value="{{old('OTpaymentplan')}}">
                </div>
        </div>
          <fieldset class="scheduler-border">
            <legend class="scheduler-border">အခြေခံလုပ်ခအပြင် အခြားပေးချေငွေများနှင့် စည်းကမ်းချက်များ</legend>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">             
                              <div class="row">
                                <div class="col-sm-6">
                                  <input type="text"placeholder="အနည်းဆုံး" class="form-control" name="miniexperprize" value="{{old('miniexperprize')}}"/>
                                </div>
                                <div class="col-sm-6">
                                  <input type="text"placeholder="အများဆုံး" class="form-control" name="maxexperprize" value="{{old('maxexperprize')}}"/>
                                </div>
                              </div>
                            </div>
                          </div>          
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">             
                              <div class="row">
                                <div class="col-sm-6">
                                  <input type="text"placeholder="အနည်းဆုံး" class="form-control" name="miniregularprize" value="{{old('miniregularprize')}}"/>
                                </div>
                                <div class="col-sm-6">
                                  <input type="text"placeholder="အများဆုံး" class="form-control" name="maxregularprizee" value="{{old('maxregularprize')}}"/>
                                </div>
                              </div>
                            </div>
                          </div>          
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-md-4">              
                              <input type="text"placeholder="အနည်းဆုံး" class="form-control" name="miniproductprize" value="{{old('miniproductprize')}}"/>
                            </div>
                            <div class="col-md-4">              
                              <input type="text"placeholder="အများဆုံး" class="form-control" name="maxproductprize" value="{{old('maxproductprize')}}"/>
                            </div>
                          </div>          
                        </div>
              ...
              <div class="row">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="control-group">
                         <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="custom-control custom-radio mb-3">
                              <input  class="custom-control-input" id="fine1" type="radio" name="fine" value='မရှိ' @if(old('fine')=='မရှိ') checked @endif>
                ...
                <div class="col-sm-6 text-left">
                    ...
                    <input  name="deductamount" id="deductamount" class="form-control" value="{{old('deductamount')}}">
                </div>
              </div>
          <fieldset class="scheduler-border">
                  ...
                  <div class="col-sm-12 text-center">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text"placeholder="ကာလ" class="form-control" name="illegaldeductedtime" value="{{old('illegaldeductedtime')}}"/>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text"placeholder="လုပ်သားအရေအတွက်" class="form-control" name="illegaldeductedworkers" value="{{old('illegaldeductedworkers')}}"/>
                        </div>
                                    
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text"placeholder="သင့်ငွေ" class="form-control" name="illegaldedutedamount" value="{{old('illegaldedutedamount')}}"/>
                ...
                <legend class="scheduler-border">လုပ်ခပေးချေခြင်း မှတ်တမ်း</legend>
                  <div class="control-group">
                       <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="custom-control custom-radio mb-3">
                            <input  class="custom-control-input" id="customRadio0" type="radio" name="paymentnote" value='မရှိ' @if(old('paymentnote')=='မရှိ') checked @endif>
                  ...
                  <div class="col-sm-6 text-center">
                    <fieldset class="scheduler-border">
                      ...
                      <div class="control-group">
                        ...
                        <div class="col-sm-6">
                          <div class="custom-control custom-radio mb-3">
                            <input  class="custom-control-input" id="deductednote1"  type="radio" name="deductednote" value='မရှိ' @if(old('deductednote')=='မရှိ') checked @endif>
            ...
            <div class="col-sm-5 text-center">
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-control custom-radio mb-3">
                      <input  class="custom-control-input" id="allowotnote1"  type="radio" name="allowotnote" value='မရှိ' @if(old('allowotnote')=='မရှိ') checked @endif>
            ...
            <div class="col-sm-12 text-center">
              <fieldset class="scheduler-border">
                ...
                <div class="control-group">
                 ...
                 <div class="row">
                        <div class="col-sm-12 text-center">
                           <textarea class="col-sm-12 form-control" rows="4" placeholder="ညွှန်ကြားရန်အချက် (ဃ)" name="instruction4">{{old('instruction4')}}</textarea>
                        </div>
                     </div>
                     <div class="blank10"></div>
                     <div class="row">
                        <div class="col-sm-12 text-center">
                           <textarea class="col-sm-12 form-control" rows="4" placeholder="ညွှန်ကြားရန်အချက် (င)" name="instruction5">{{old('instruction5')}}</textarea>
                        </div>
                     </div>
                     <div class="blank10"></div>
                </div>
