...
class CreateShopLabourInspectionLawsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('shop_labour_inspection_laws', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('shop_labour_inspection_laws');
    }
}
