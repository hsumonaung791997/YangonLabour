...
class CreateTempShopInspectionSafetiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_shop_inspection_safeties', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('temp_shop_inspection_safeties');
    }
}
