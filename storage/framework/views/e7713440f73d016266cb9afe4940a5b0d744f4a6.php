 ...
 <p>
  ...
  <p>
    ...
    <div id="GI">
      ...
      <div class="col-sm-8">
      <textarea  name="aleavedesc" class="col-sm-12"><?php echo e(old('aleavedesc')); ?></textarea>
      </div>
      ...
      <div class="col-sm-8">
        <textarea  name="awagedesc" class="col-sm-12"><?php echo e(old('awagedesc')); ?></textarea>
      </div>
      ...
      <div class="col-sm-8">
        <textarea  name="anotedesc" class="col-sm-12"><?php echo e(old('anotedesc')); ?></textarea>
      </div>
      ...
      <div class="col-sm-8">
        <textarea  name="aworktimedesc" class="col-sm-12"><?php echo e(old('aworktimedesc')); ?></textarea>
      </div>
      ...
      <div class="col-sm-8">
        <textarea  name="aotherdesc" class="col-sm-12"><?php echo e(old('aotherdesc')); ?></textarea>
      </div>
    ...
    <div id="IF">
      ...
      <div class="col-sm-8">
        <textarea  name="fsafetydesc" class="col-sm-12"><?php echo e(old('fsafetydesc')); ?></textarea>
      </div>
...
ကျန်းမာ</label></div>
      <div class="col-sm-8">
        <textarea  name="fhealthdesc" class="col-sm-12"><?php echo e(old('fhealthdesc')); ?></textarea>
      </div>
      ...
      <div class="col-sm-8">
        <textarea  name="fwelfaredesc" class="col-sm-12"><?php echo e(old('fwelfaredesc')); ?></textarea>
      </div>
      ...
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">မှတ်တမ်း</label></div>
      <div class="col-sm-8">
        <textarea  name="fnotedesc" class="col-sm-12"><?php echo e(old('fnotedesc')); ?></textarea>
      </div>
      ...
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">အခြား</label></div>
      <div class="col-sm-8">
        <textarea  name="fotherdesc" class="col-sm-12"><?php echo e(old('fotherdesc')); ?></textarea>
      </div>
