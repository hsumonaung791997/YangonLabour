...
<form action="<?php echo e(route('Factoryprosecuted.store')); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="factory_name" id="factory_Name" class="form-control" value="<?php echo e(old('factory_name')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="factory_IDno" id="factory_IDno" class="form-control" value="<?php echo e(old('factory_IDno')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="factory_address" id="factory_Address" class="form-control" value="<?php echo e(old('factory_address')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="factory_township" id="factory_Township" class="form-control" value="<?php echo e(old('factory_township')); ?>">
                                                <input type="hidden" name="factory_township_id" id="townshipid" class="form-control" value="<?php echo e(old('factory_township_id')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="factory_Zone" id="factory_Zone" class="form-control" value="<?php echo e(old('factory_Zone')); ?>">
                                            <input type="hidden" name="factory_zone" id="zoneid" class="form-control" value="<?php echo e(old('factory_zone')); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="shop_name" id="shop_Name" class="form-control" value="<?php echo e(old('shop_name')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="shop_IDno" id="shop_IDno" class="form-control" value="<?php echo e(old('shop_IDno')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="shop_address" id="shop_Address" class="form-control" value="<?php echo e(old('shop_address')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="shop_township" id="shop_Township" class="form-control" value="<?php echo e(old('shop_township')); ?>">
                                                <input type="hidden" name="shop_township_id" id="township_id" class="form-control" value="<?php echo e(old('shop_township_id')); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="OwnerName" id="OwnerName" class="form-control" value="<?php echo e(old('OwnerName')); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <textarea name="OwnerAddress" id="OwnerAddress" class="form-control" required><?php echo e(old('OwnerAddress')); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="ManagerName" id="ManagerName" class="form-control" value="<?php echo e(old('ManagerName')); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <textarea name="ManagerAddress" id="ManagerAddress" class="form-control" required><?php echo e(old('ManagerAddress')); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="PlaintiffName" id="PlaintiffName" class="form-control" required value="<?php echo e(old('PlaintiffName')); ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="PlaintiffLvl" id="PlaintiffLvl" class="form-control" required value="<?php echo e(old('PlaintiffLvl')); ?>">    
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="PlaintiffTownship" id="PlaintiffTownship" class="form-control" required value="<?php echo e(old('PlaintiffTownship')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="PlaintiffZone" id="PlaintiffZone" class="form-control" required value="<?php echo e(old('PlaintiffZone')); ?>">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-12">
                        <fieldset class="scheduler-border">
				            <legend class="scheduler-border">တရားစွဲဆိုရသည့်အကြောင်းအရင်း <span style="color:red">*</span></legend>
                                <div class="row">
                                    <div class="col-sm-12">
                                    <textarea name="ProsecutedAbout" id="ProsecutedAbout" class="form-control" required><?php echo e(old('ProsecutedAbout')); ?></textarea>
                                    </div>
                                </div>                            
                        </fieldset>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <fieldset class="scheduler-border">
				            <legend class="scheduler-border">ကျူးလွန်သောဥပဒေနှင့်စွဲဆိုသည့်ပုဒ်မ <span style="color:red">*</span></legend>
                                <div class="row">
                                    <div class="col-sm-12">
                                    <textarea name="ProsecutedLaw" id="ProsecutedLaw" class="form-control" required><?php echo e(old('ProsecutedLaw')); ?></textarea>
                                    </div>
                                </div>
                        </fieldset>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="date" name="ProsecutedDay" id="datepicker" class="form-control datepicker" required value="<?php echo e(old('ProsecutedDay')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                            <input type="text" name="CourtName" id="CourtName" class="form-control" required value="<?php echo e(old('CourtName')); ?>">
                                            </div>
                                        </div>
                                    </div>
