<?php $__env->startSection('content'); ?>
    ...
    <p>
     ...
     <p>
        <div class="row">
            <div class="col-sm-5">
                <form action="<?php echo e(route('autocomplete.searchdata')); ?>" method="POST" role="search" style="margin:auto;max-width:300px" class="search">
            ...
            <div class="col-sm-4 text-right">
                <div class="pull-right">
                    <a class="btn btn-primary" href="<?php echo e(route('closefactory.list')); ?>"> ပိတ်သိမ်းထားသော စက်ရုံအလုပ်ရုံများ ကြည့်ရန်</a>
                </div>
            </div>
            <div class="col-sm-3 text-right">
                <div class="pull-right">
                    <a class="btn btn-primary" href="<?php echo e(route('factories.create')); ?>"> စက်ရုံအလုပ်ရုံများ လျှောက်ထားရန်</a>
                </div>
            </div>
        </div>
    </p>
                ...
                <td class="completion">
                    <form action="<?php echo e(route('factories.destroy',$factories->id)); ?>" method="POST" class="delete">
                        ...
                        <button type="submit" class="badge badge-danger" id="factorydelete">ဖျက်မည်</button> |
                         ...
                         <a href="<?php echo e(url('CloseFactory/'.$factories->FactoryId)); ?>" class="badge badge-pill badge-warning" data-toggle="modal" data-target="#exampleModal"> ပိတ်သိမ်းမည် </a> <br>
                         <a href="<?php echo e(route('factories.download',$factories->id)); ?>" class="badge badge-success">Download</a> 
                    </form>
                </td>
