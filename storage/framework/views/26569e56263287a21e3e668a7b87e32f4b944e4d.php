     ...
     <form  action="<?php echo e(route('PermissionOtFactory.store')); ?>" method="post" enctype="multipart/form-data">
        ...
        <br>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="TotalWorker" class="form-control" name="TotalWorker" onfocus="converunistring()">
                </div>
            </div>
            <div class="blank10"></div>
            <div class="row">
                ...
                <div class="col-sm-4">
                    <input type="text" id="Othour" class="form-control" name="Othour" onblur="converunistring()">
                </div>
            </div>
            <div class="blank10"></div>
            <div class="row">
