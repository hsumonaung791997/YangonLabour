<?php $__env->startSection('content'); ?>
    ...
    <div>
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2>သင်တန်းစီမံချက်လချူပ်များ</h2>
            </div>
        </div>
        <div class="row">
                            ...
                            <tbody class="list">
                                ...
                                <?php $__currentLoopData = $report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($r->Name); ?> <br> (<?php echo e($r->chooseType); ?>)
                                        </td>
                                        <td>
    ...
    <div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2>စက်ရုံဖွင့် / ပိတ်နှင့် လုပ်သားအတိုး / အလျော့စာရင်း</h2>
                </div>
            </div>
            <div class="row">
                <div class="table-responsive">
                ...
                <table class="table table-bordered" id="myTable">
                    ...
                    <?php $i=0; ?>
                         <tr>
                            ...
                            <td>
                                <?php echo e(App\Township::where('id',App\User::where('id',Auth::user()->id)->value('township_id'))->value('township_name')); ?>
    ...
    <div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2>မတော်တဆထိခိုက်မှု စစ်ဆေးခြင်းလချူပ်</h2>
                </div>
            </div>
            <div class="row">
                <div class="table-responsive">
    ...
    <div>
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2>မတော်တဆထိခိုက်မှု ရရှိခြင်းလချူပ်</h2>
            </div>
        </div>
        <div class="row">
            <div class="table-responsive">
            ...
            <table class="table table-bordered" id="myTable">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo e(App\Township::where('id',App\Factory::where('FactoryId',$r->FactoryID)->value('township_id'))->value('township_name')); ?> <br> 
                        (<?php if($r->Type==1): ?>
                        စက်ရုံ/အလုပ်ရုံ
                        <?php else: ?>
                        ဆိုင်အလုပ်ဌာန
    ...
    <div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2>စစ်ဆေးဆောင့်ရွက်ချက် လချုပ်(GLI)</h2>
                </div>
            </div>
            <div class="row">
                <div class="table-responsive">
