		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="numholidays1" type="radio" name="numholidays" value="မရှိ" <?php if(old('numholidays')=='မရှိ'): ?> checked <?php endif; ?>>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="opportunityhol1" type="radio" name="opportunityhol" value="မပြု" <?php if(old('apportunityhol')=='မပြု'): ?> checked <?php endif; ?>>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="paidwage1" type="radio" name="paidwage" value="မရှိ"  <?php if(old('paidwage')=='မရှိ'): ?> checked <?php endif; ?> >
			...
			<legend class="scheduler-border">လုပ်သက်ခွင့်ရက်ကို နှစ်စဉ် ခံစားခွင့်  </legend>
				<div class="control-group">
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="vacationdays1" type="radio" name="vacationdays" value="မပေး" <?php if(old('vacationdays')=='မပေး'): ?> checked <?php endif; ?>>
			...
			<legend class="scheduler-border">အလုပ်မှ နုတ်ထွက် ထုတ်ပြစ်သော လုပ်သားများအား ခွင့်ရက်အစား အခကြေးငွေကို ရှင်းပေးခြင်း</legend>
				<div class="control-group">
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="custom-control custom-radio mb-3">
								<input  class="custom-control-input" id="workerfrees1" type="radio" name="workerfrees" value="မရှိ" <?php if(old('workerfrees')=='မရှိ'): ?> checked <?php endif; ?>>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="annual1" type="radio" name="annual" value="မရှိ" <?php if(old('annual')=='မရှိ'): ?> checked <?php endif; ?>>
		  				...
		  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="contract1" type="radio" name="contract" value="မရှိ" <?php if(old('contract')=='မရှိ'): ?> checked <?php endif; ?>>
  				...
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
									...
									<div class="col-sm-6">
										<div class="custom-control custom-radio mb-3">
											<input  class="custom-control-input" id="registrationbook1" type="radio" name="registrationbook" value="မရှိ" <?php if(old('registrationbook')=='မရှိ'): ?> checked <?php endif; ?>>
  		...
  		<div class="col-sm-6">
  				<fieldset class="scheduler-border">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-12">
								 		<input type="text" class="form-control" name="medicalticketqan" value="<?php echo e(old('medicalticketqan')); ?>"/>
								 	</div>
								 </div>
						    </div>
				</fieldset>
...
<div class="tab">
	...
	<div class="row">
		<div class="col-sm-6 text-center">
		  	<textarea class="col-sm-12 form-control" rows="4" placeholder="ယခင်က ပြစ်မှုထင်ရှား စီရင်ခြင်း ခံရလျှင် အဆိုပါ အကြောင်းအရာများကို ဖော်ပြရန်" id="letter" name="passionremark"><?php echo e(old('passionremark')); ?></textarea>		
		  			
		</div>
		<div class="col-sm-6 text-center">
		  	<textarea class="col-sm-12 form-control" rows="4" placeholder="အထွေထွေမှတ်ချက်များ" id="letter" name="generalremark"><?php echo e(old('generalremark')); ?></textarea>		
	...
	<div class="row">
		<div class="col-sm-12 text-center">
		  	<textarea class="col-sm-12 form-control" rows="4" placeholder="အထက်အရာရှိမှတ်ချက်" id="letter" name="officeremark"><?php echo e(old('officeremark')); ?></textarea>		
    ...
    <h3 class="text-center text-primary">၂၀၁၆ ခုနှစ် ဆိုင်များနှင့်အလုပ်ဌာနများ အက်ဥပေဒေ</h3>
            ...
            <div class="row">
               <div class="col-sm-12">
                    ...
                    <textarea rows="4" class="col-sm-12 form-control" name="work_duration" id="workduration"><?php echo e(old('work_duration')); ?>   
                    </textarea>
                </div>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="worktimenotice1" type="radio" name="worktime_notice" value="မပြု" <?php if(old('worktime_notice')=='မပြု'): ?> checked <?php endif; ?>>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="SSB1" type="radio" name="SSB" value="မထား" <?php if(old('SSB')=='မထား'): ?> checked <?php endif; ?>>
                ...
                <div class="row">               
                    <div class="col-sm-5 text-center">
                            ...
                            <div class="control-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-radio mb-3">
                                            <input  class="custom-control-input" id="salarytime1" type="radio" name="salary_time" value="မပေး" <?php if(old('salary_time')=='မပေး'): ?> checked <?php endif; ?>>
                    ...
                    <div class="col-sm-6 text-center">
                      <label for="weekendholiday">ရက်သတ္တပတ်ပိတ်ရက်</label>
                        <input type="text" id='weekendholiday' class="form-control" name="weekend_holiday" value="<?php echo e(old('weekend_holiday')); ?>"/>
                    </div>
                </div>
	<div class="row">
		...
		<div class="col-sm-5 text-center">
		  		<input type="text" name="inspectionname" id="inspectionname" class="form-control" value="<?php echo e(old('inspectionname')); ?>">	
