<?php $__env->startSection('content'); ?>
    ...
    <h1>ဆိုင် / အလုပ်ဌာန ပိတ်သိမ်းခြင်း </h1>
...
<form  class="form-background" action="<?php echo e(route('Close.Shop')); ?>" method="post" enctype="multipart/form-data">
     ...
     <p>
        <div class="row">
            <div class="col-sm-4 text-right">
                <input type="hidden" value=<?php echo e($shop->ShopId); ?> name="shop_id">
                <label for="">ဆိုင် / အလုပ်ဌာန အမည် - </label>
            </div>
            <div class="col-sm-8">
     ...
     <p>
        <div class="row">
            <div class="col-sm-4 text-right">
                 <input type="hidden" value="<?php echo  $township.'၊'. $shop->loacationaddress?>" name="ShopAddress">
                <label for="">ဆိုင် / အလုပ်ဌာန လိပ်စာ - </label>
            </div>
            <div class="col-sm-8">
                <?php echo e($township); ?> ၊ <?php echo e($shop->loacationaddress); ?>
         ...
         <p>
            <div class="row">
                <div class="col-sm-4 text-right">
                    <label for="DesCloseFactory">ဆိုင် / အလုပ်ဌာန ပိတ်သိမ်းရသည့် အကြောင်းရင်း - </label>
                </div>
                <div class="col-sm-8">
