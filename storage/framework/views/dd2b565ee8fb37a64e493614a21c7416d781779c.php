                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo e(App\Factory::whereMonth('RegDate', '=',Carbon\Carbon::now()->month)->whereYear('RegDate','=',Carbon\Carbon::now()->year)->count()); ?></span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo e(App\FactoryInspectionInforms::whereMonth('inspectiondate', '=',Carbon\Carbon::now()->month)->whereYear('inspectiondate','=',Carbon\Carbon::now()->year)->count()); ?></span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                     ...
                     <span class="h2 font-weight-bold mb-0"><?php echo e(App\Shop::whereMonth('RegDate', '=',Carbon\Carbon::now()->month)->count()); ?></span>
                    </div>
                    <div class="col-auto">
