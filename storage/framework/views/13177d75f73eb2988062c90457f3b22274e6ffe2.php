						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="ကျား" name="menworker" value="<?php echo e(old('menworker')); ?>" id="menworker" class="form-control" />
									</div>
									<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="မ" name="womenworker"  value="<?php echo e(old('womenworker')); ?>" id="womenworker" class="form-control" />
									</div>
									<div class="col-sm-4 text-center">
