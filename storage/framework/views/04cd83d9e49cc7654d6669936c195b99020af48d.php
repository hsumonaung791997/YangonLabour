		...
		<p>
			<div class="row">
				<div class="col-sm-5 text-center">
					...
					<input  name="FactoryName" id="FactoryName" value="<?php echo e($factory->FactoryName==null ? old('FactoryName') : $factory->FactoryName); ?>">
				</div>
				<div class="col-sm-1">
				...
				<div class="col-sm-6 text-center">
					...
					<input  name="EmailAdd" id="EmailAdd" value="<?php echo e($factory->EmailAdd==null ? old('EmailAdd') : $factory->EmailAdd); ?>">
				</div>
			</div>
		</p>
		<p>
			<div class="row">
				<div class="col-sm-5 text-center">
					...
					<input  name="ContactFax" id="ContactFax" value="<?php echo e($factory->ContactFax==null ? old('ContactFax') : $factory->ContactFax); ?>">
				</div>
				<div class="col-sm-1">
				...
				<div class="col-sm-6 text-center">
					...
					<input  name="ContactPhone" id="ContactPhone" value="<?php echo e($factory->ContactPhone==null ? old('ContactPhone') : $factory->ContactPhone); ?>">
				</div>
			</div>
		</p>
		<p>
			<div class="row">
				<div class="col-sm-5 text-center">
					...
					<input id="NoticeAddress"    name="NoticeAddress" value="<?php echo e($factory->NoticeAddress==null ? old('NoticeAddress') : $factory->NoticeAddress); ?>">
				</div>
				<div class="col-sm-1">
				</div>
				<div class="col-sm-6 text-center">
					...
					<input  name="ContactAddress" id="ContactAddress" value="<?php echo e($factory->ContactAddress==null ? old('ContactAddress') : $factory->ContactAddress); ?>">
				</div>
			</div>
		</p>
		<p>
			<div class="row">
				<div class="col-sm-5 text-center">
					...
					<input   name="WorkedPower" id="WorkedPower" value="<?php echo e($factory->WorkedPower==null ? old('WorkedPower') : $factory->WorkedPower); ?>">
				</div>
				<div class="col-sm-1">
				...
				<div class="col-sm-6 text-center">
					...
					<input id="ElectricPower" name="ElectricPower" value="<?php echo e($factory->ElectricPower==null ? old('ElectricPower') : $factory->ElectricPower); ?>">
				</div>
			</div>
		</p>
		...
		<p>
			<div class="row">
				<div class="col-sm-5 text-center">
					...
					<input  type="date" name="PreNoticeDate" id="PreNoticeDate" value="<?php echo e($factory->PreNoticeDate==null ? old('PreNoticeDate') : $factory->PreNoticeDate); ?>">
				</div>
				<div class="col-sm-1">
				...
				<div class="col-sm-6 text-center">
					...
					<input id="RegDate" name="RegDate" type="date" value="<?php echo e($factory->RegDate==null ? old('RegDate') : $factory->RegDate); ?>">
				</div>
			</div>
		</p>
<p>
			<div class="row">
					...
					<fieldset class="scheduler-border">
					  ...
					  <div class="control-group">
						  ...
						  <div class="row">
							  ...
							  <div class="col-sm-6 text-left">
								  <select id="township_id" class="form-control" name="township_id">
								  	<?php if($township): ?>
								  	<option value="<?php echo e($factory->township_id); ?>"><?php echo e($township); ?>
						  ...
						  <div class="row">
							  ...
							  <div class="col-sm-6 text-left">
								  <select name="zone_id" id="zone_id" class="form-control">
								  		<?php if($township): ?>
										  	<option value="<?php echo e($factory->zone_id); ?>"><?php echo e($zone); ?>
						  ...
						  <div class="row">
							  ...
							  <div class="col-sm-6 text-left">
								  <textarea class="form-control form-control-alternative" rows="3" placeholder="အသေးစိတ်ထည့်ရန်" id='address' name="FactoryAddress"><?php echo e($factory->FactoryAddress==null ? old('FactoryAddress') : $factory->FactoryAddress); ?></textarea>
							  </div>
						  </div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-12">
	  				...
	  				<textarea class="col-sm-12" rows="4" id="NextYearProcess" name="NextYearProcess"><?php echo e($factory->NextYearProcess==null ? old('NextYearProcess') : $factory->NextYearProcess); ?></textarea>
	  			</div>
	  		</div>
	  	</p>
	  	...
	  	<p>(အောက်ပါဇယားကွက်တွင်စက်ကိရိယာအသီးသီးတို့၏မြင်းကောင်ရေအားကိုဖော်ပြရန်)</p>
	  		<div class="row">
	 			<div class="col-sm-5 text-center">
					...
					<input id="StreamHP" value="<?php echo e($factory->StreamHP==null ? old('StreamHP') : $factory->StreamHP); ?>"  name="StreamHP">
				</div>
				<div class="col-sm-1">
	 			...
	 			<div class="col-sm-6 text-left">
					...
					<input id="GasHP" value="<?php echo e($factory->GasHP==null ? old('GasHP') : $factory->GasHP); ?>"  name="GasHP">
				</div>
			</div> <br>
			<div class="row">
	 			<div class="col-sm-5">
	 				<label for="MotorHP">လျှပ်စစ်ဖြင့်လည်သောစက်</label>
					<input id="MotorHP" value="<?php echo e($factory->MotorHP==null ? old('MotorHP') : $factory->MotorHP); ?>" name="MotorHP">
				</div>
				<div class="col-sm-1">
	 			...
	 			<div class="col-sm-6">
					...
					<input id="WaterHP" value="<?php echo e($factory->WaterHP==null ? old('WaterHP') : $factory->WaterHP); ?>"  name="WaterHP">
				</div>
			</div>
			<br>
				...
				<div class="col-sm-12">
					<table style="width:100%" border="1">
					  ...
					  <tr>
					    ...
					    <td><input type='text' value="<?php echo e($factory->MenWorker==null ? old('MenWorker') : $factory->MenWorker); ?>" name="MenWorker" id="MenWorker" onkeyup="converunistring('man')"></td>
					    <td><input type='text' value="<?php echo e($factory->WomenWorker==null ? old('WomenWorker') : $factory->WomenWorker); ?>" name="WomenWorker" id="WomenWorker" onkeyup="converunistring('women')"></td>
					    <td><input type='text' value="<?php echo e($factory->AMenWorker==null ? old('AMenWorker') : $factory->AMenWorker); ?>" name="AMenWorker" id="AMenWorker"  onkeyup="converunistring('amen')" > </td>
					    <td><input type='text' value="<?php echo e($factory->AWomenWorker==null ? old('AWomenWorker') : $factory->AWomenWorker); ?>" name="AWomenWorker" id="AWomenWorker" onkeyup="converunistring('awomen')"></td>
					    <td><input type='text' value="<?php echo e($factory->CMenWorker==null ? old('CMenWorker') : $factory->CMenWorker); ?>" name="CMenWorker" id="CMenWorker" onkeyup="converunistring('cman')" ></td>
					    <td><input type='text' value="<?php echo e($factory->CWomenWorker==null ? old('CWomenWorker') : $factory->CWomenWorker); ?>" name="CWomenWorker" id="CWomenWorker" onkeyup="converunistring('cwomen')"></td>
					  </tr>
					   <tr>
					    <td>နေ့စား</td>
					    <td><input type='text' value="<?php echo e($factory->DailyMenWorker==null ? old('DailyMenWorker') : $factory->DailyMenWorker); ?>" name="DailyMenWorker" id="DailyMenWorker" onkeyup="converunistring('man')"></td>
					    <td><input type='text' value="<?php echo e($factory->DailyWomenWorker==null ? old('DailyWomenWorker') : $factory->DailyWomenWorker); ?>" name="DailyWomenWorker" id="DailyWomenWorker" onkeyup="converunistring('women')"></td>
					    <td><input type='text' value="<?php echo e($factory->ADailyMenWorker==null ? old('ADailyMenWorker') : $factory->ADailyMenWorker); ?>" name="ADailyMenWorker" id="ADailyMenWorker" onkeyup="converunistring('amen')"></td>
					    <td><input type='text' value="<?php echo e($factory->ADailyWomenWorker==null ? old('ADailyWomenWorker') : $factory->ADailyWomenWorker); ?>" name="ADailyWomenWorker" id="ADailyWomenWorker" onkeyup="converunistring('awomen')"></td>
					    <td><input type='text' value="<?php echo e($factory->CDailyMenWorker==null ? old('CDailyMenWorker') : $factory->CDailyMenWorker); ?>" name="CDailyMenWorker" id="CDailyMenWorker" onkeyup="converunistring('cman')"></td>
					    <td><input type='text' value="<?php echo e($factory->CDailyWomenWorker==null ? old('CDailyWomenWorker') : $factory->CDailyWomenWorker); ?>" name="CDailyWomenWorker" id="CDailyWomenWorker" onkeyup="converunistring('cwomen')"></td>
					  </tr>
					  <tr>
					    <td>ပုတ်ပြတ်</td>
					    <td><input type='text' value="<?php echo e($factory->PieceMenWorker==null ? old('PieceMenWorker') : $factory->PieceMenWorker); ?>" name="PieceMenWorker" id="PieceMenWorker" onkeyup="converunistring('man')"></td>
					    <td><input type='text' value="<?php echo e($factory->PieceWomenWorker==null ? old('PieceWomenWorker') : $factory->PieceWomenWorker); ?>" name="PieceWomenWorker" id="PieceWomenWorker" onkeyup="converunistring('women')"> </td>
					    <td><input type='text' value="<?php echo e($factory->APieceMenWorker==null ? old('APieceMenWorker') : $factory->APieceMenWorker); ?>" name="APieceMenWorker" id="APieceMenWorker" onkeyup="converunistring('amen')"></td>
					    <td><input type='text' value="<?php echo e($factory->APieceWomenWorker==null ? old('APieceWomenWorker') : $factory->APieceWomenWorker); ?>" name="APieceWomenWorker" id="APieceWomenWorker" onkeyup="converunistring('awomen')"></td>
					    <td><input type='text' value="<?php echo e($factory->CPieceMenWorker==null ? old('CPieceMenWorker') : $factory->CPieceMenWorker); ?>" name="CPieceMenWorker" id="CPieceMenWorker" onkeyup="converunistring('cman')"></td>
					    <td><input type='text' value="<?php echo e($factory->CPieceWomenWorker==null ? old('CPieceWomenWorker') : $factory->CPieceWomenWorker); ?>" name="CPieceWomenWorker" id="CPieceWomenWorker" onkeyup="converunistring('cwomen')"></td>
					  </tr>
					  <tr>
					    <td>စုစုပေါင်း</td>
					  <td> <input type="text" id="totalman" name="totalMan" value="<?php echo e(old('totalMan')==null ? 0 : old('totalMan')); ?>"></td>
					    <td><input type="text" id="totalWomen" name="totalWomen" value="<?php echo e(old('totalWomen')==null ? 0 : old('totalWomen')); ?>"></td>
					    <td><input type="text" id="totalaman" name="totalAman" value="<?php echo e(old('totalAman')==null ? 0 : old('totalAman')); ?>"></td>
					    <td><input type="text" id="totalawomen" name="totalAwomen" value="<?php echo e(old('totalAwomen')==null ? 0 : old('totalAwomen')); ?>"></td>
					    <td><input type="text" id="totalcman" name="totalCman" value="<?php echo e(old('totalCman')==null ? 0 : old('totalCman')); ?>"></td>
					    <td><input type="text" id="totalcwomen" name="totalCwomen" value="<?php echo e(old('totalCwomen')==null ? 0 : old('totalCwomen')); ?>"></td>
					  </tr>
					</table> <br>
				</div>
			</div>

			<input type="hidden" id="total_man" name="totalMaleWorker" value="<?php echo e(old('totalMaleWorker')==null ? 0 : old('totalMaleWorker')); ?>">
			<input type="hidden" id="total_women" name="totalFemaleWorker" value="<?php echo e(old('totalFemaleWorker')==null ? 0 : old('totalFemaleWorker')); ?>">

			<p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				<label id="datepicker">အလုပ်ရုံစတင် လုပ်ကိုင်သောရက်စွဲ</label>
		  				<input type="date" value="<?php echo e($factory->StartDate==null ? old('StartDate') : $factory->StartDate); ?>"   name="StartDate" id="datepicker" class="datepicker">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="ManagerName" value="<?php echo e($factory->ManagerName==null ? old('ManagerName') : $factory->ManagerName); ?>"  name="ManagerName">
		  			</div>
		  		</div>
	  		</p>
	  		<p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input value="<?php echo e($factory->OwnerName==null ? old('OwnerName') : $factory->OwnerName); ?>"  name="OwnerName" id="OwnerName">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="OwnerNrc" value="<?php echo e($factory->OwnerNrc==null ? old('OwnerNrc') : $factory->OwnerNrc); ?>"  name="OwnerNrc">
		  			</div>
		  		</div>
	  		</p>
	  		<p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input value="<?php echo e($factory->OwnerAddress==null ? old('OwnerAddress') : $factory->OwnerAddress); ?>" id="OwnerAddress"  name="OwnerAddress">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="OwnerPhno" value="<?php echo e($factory->OwnerPhno==null ? old('OwnerPhno') : $factory->OwnerPhno); ?>"  name="OwnerPhno">
		  			</div>
		  		</div>
	  		</p>
	  		<p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input id="OwnerFax" value="<?php echo e($factory->OwnerFax==null ? old('OwnerFax') : $factory->OwnerFax); ?>" name="OwnerFax">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input value="<?php echo e($factory->OwnerEmail==null ? old('OwnerEmail') : $factory->OwnerEmail); ?>" id="OwnerEmail" name="OwnerEmail">
		  			</div>
		  		</div>
	  		</p>
	  		<p>
				<div class="row">
					<div class="col-sm-5 text-center">
						...
						<input id="OwnerPassport"  name="OwnerPassport" value="<?php echo e($factory->OwnerPassport==null ? old('OwnerPassport') : $factory->OwnerPassport); ?>">
					</div>
					<div class="col-sm-1">
					...
					<div class="col-sm-6 text-center">
						...
						<input type="date" name="TestingDate" id="datepicker" class="datepicker" value="<?php echo e($factory->TestingDate==null ? old('TestingDate') : $factory->TestingDate); ?>">
					</div>
				</div>
			</p>
	  		<p>
		    ...
		    <p>
		  		<div class="row">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="UsedPower" value="<?php echo e($factory->UsedPower==null ? old('UsedPower') : $factory->UsedPower); ?>" oninput="this.className = ''" name="UsedPower">
		  			</div>
		  		</div>
	  		</p>
	  		 <p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input id="MonthlyAmounts" value="<?php echo e($factory->MonthlyAmounts==null ? old('MonthlyAmounts') : $factory->MonthlyAmounts); ?>" oninput="this.className = ''" name="MonthlyAmounts">
		  			</div>
		  			<div class="col-sm-1">
	  		 ...
	  		 <p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input id="ProducedProduct" value="<?php echo e($factory->ProducedProduct==null ? old('ProducedProduct') : $factory->ProducedProduct); ?>" oninput="this.className = ''" name="ProducedProduct" required="">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="ProducedOthers" value="<?php echo e($factory->ProducedOthers==null ? old('ProducedOthers') : $factory->ProducedOthers); ?>" oninput="this.className = ''" name="ProducedOthers">
		  			</div>
		  		</div>
	  		</p>
	  		<p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input id="RawMaterials" value="<?php echo e($factory->RawMaterials==null ? old('RawMaterials') : $factory->RawMaterials); ?>" oninput="this.className = ''" name="RawMaterials">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="Goods" value="<?php echo e($factory->Goods==null ? old('Goods') : $factory->Goods); ?>" oninput="this.className = ''" name="Goods">
		  			</div>
		  		</div>
	  		</p>
				...
				<div class="col-sm-12"> 
					<table style="width:100%" border="1">
					  ...
					  <tr>
					    ...
					    <td><input type='text' value="<?php echo e($factory->CitizenMenWorker==null ? old('CitizenMenWorker') : $factory->CitizenMenWorker); ?>"  name="CitizenMenWorker" id="CitizenMenWorker"></td>
					    <td><input type='text' value="<?php echo e($factory->CitizenWomenWorker==null ? old('CitizenWomenWorker') : $factory->CitizenWomenWorker); ?>" name="CitizenWomenWorker" id="CitizenWomenWorker"></td>
					  </tr>
					   <tr>
					    <th>နိုင်ငံခြားသားလုပ်သား</th>
					    <td><input type='text' value="<?php echo e($factory->ForeignerMenWorker==null ? old('ForeignerMenWorker') : $factory->ForeignerMenWorker); ?>" name="ForeignerMenWorker" id="ForeignerMenWorker"></td>
					    <td><input type='text' value="<?php echo e($factory->ForeignerWomenWorker==null ? old('ForeignerWomenWorker') : $factory->ForeignerWomenWorker); ?>" name="ForeignerWomenWorker" id="ForeignerWomenWorker"></td>
					  </tr>
					</table> <br>
				</div>
			</div>
	  		...
	  		<p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input id="MinimumSalary" value="<?php echo e($factory->MinimumSalary==null ? old('MinimumSalary') : $factory->MinimumSalary); ?>" oninput="this.className = ''" name="MinimumSalary">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input value="<?php echo e($factory->MaximumSalary==null ? old('MaximumSalary') : $factory->MaximumSalary); ?>" oninput="this.className = ''" name="MaximumSalary">
		  			</div>
		  		</div>
	  		</p>
					    ...
					    <div class="control-group">
					    	...
					    	<div class="row">
					    		...
					    		<div class="col-sm-4 text-right">
					    			 <input class="form-control" type="time"  id="example-time-input" name="MToSTimein" value="<?php echo e($factory->MToSTimein==null ? old('MToSTimein') : $factory->MToSTimein); ?>">
					    		</div>
					    	</div> <br>
					    	<div class="row">
					    		<div class="col-sm-4 text-center">
					    		...
					    		<div class="col-sm-4 text-right">
					    			 <input class="form-control" type="time"  id="example-time-input" name="MToSTimeout" value="<?php echo e($factory->MToSTimeout==null ? old('MToSTimeout') : $factory->MToSTimeout); ?>">
					    		</div>
					    	</div> <br>
					    	<div class="row">
									<div class="col-sm-4 text-center">
					    	...
					    	<div class="row">
					    		<div class="col-sm-6">
					    			...
					    			<div class="row">
							    		...
							    		<div class="col-sm-6 text-right">
							    			 <input class="form-control" type="time" name="MToFTimein" id="example-time-input" value="<?php echo e($factory->MToFTimein==null ? old('MToFTimein') : $factory->MToFTimein); ?>">
							    		</div>
					    			</div> <br>
							    	<div class="row">
							    		<div class="col-sm-6 text-center">
							    		...
							    		<div class="col-sm-6 text-right">
							    			 <input class="form-control" type="time" name="MToFTimeout" id="example-time-input" value="<?php echo e($factory->MToFTimeout==null ? old('MToFTimeout') : $factory->MToFTimeout); ?>">
							    		</div>
							    	</div> <br>
							    	<div class="row">
											<div class="col-sm-6 text-center">
					    		...
					    		<div class="col-sm-6">
					    			...
					    			<div class="row">
							    		...
							    		<div class="col-sm-6 text-right">
							    			 <input class="form-control" type="time" name="STimein" id="example-time-input" value="<?php echo e($factory->STimein==null ? old('STimein') : $factory->STimein); ?>">
							    		</div>
					    			</div> <br>
							    	<div class="row">
							    		<div class="col-sm-6 text-center">
							    		...
							    		<div class="col-sm-6 text-right">
							    			 <input class="form-control" type="time" name="STimeout" id="example-time-input" value="<?php echo e($factory->STimeout==null ? old('STimeout') : $factory->STimeout); ?>"> 
							    		</div>
							    	</div> <br>
					    		</div>	
					    	</div>
						...
						<fieldset class="scheduler-border">
						  ...
						  <div class="control-group">
							  ...
							  <div class="row">
								  ...
								  <div class="col-sm-4 text-right">
									   <input class="form-control" type="time"  id="example-time-input" name="MToFTimeInOther" value="<?php echo e($factory->MToFTimeInOther==null ? old('MToFTimeInOther') : $factory->MToFTimeInOther); ?>" >
								  </div>
							  </div> <br>
							  <div class="row">
								  <div class="col-sm-4 text-center">
								  ...
								  <div class="col-sm-4 text-right">
									   <input class="form-control" type="time"  id="example-time-input" name="MToFTimeoutOther" value="<?php echo e($factory->MToFTimeoutOther==null ? old('MToFTimeoutOther') : $factory->MToFTimeoutOther); ?>">
								  </div>
							  </div> <br>
							  <div class="row">
								  <div class="col-sm-4 text-center">
	      ...
	      <p>
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
		  				...
		  				<input id="SignatureName" value="<?php echo e($factory->SignatureName==null ? old('SignatureName') : $factory->SignatureName); ?>" oninput="this.className = ''" name="SignatureName">
		  			</div>
		  			<div class="col-sm-1">
		  			...
		  			<div class="col-sm-6 text-left">
		  				...
		  				<input id="SignatureRank" oninput="this.className = ''" name="SignatureRank" value="<?php echo e($factory->SignatureRank==null ? old('SignatureRank') : $factory->SignatureRank); ?>">
		  			</div>
		  		</div>
	  		</p>
	  		...
	  		<p>
					<div class="row">
						<div class="col-sm-5 text-center">
							...
							<input id="SubscriberName" oninput="this.className = ''" name="SubscriberName" value="<?php echo e($factory->SubscriberName==null ? old('SubscriberName') : $factory->SubscriberName); ?>">
						</div>
						<div class="col-sm-1">
						...
						<div class="col-sm-6 text-center">
							...
							<input id="SubscriberRank" oninput="this.className = ''" name="SubscriberRank" value="<?php echo e($factory->SubscriberRank==null ? old('SubscriberRank') : $factory->SubscriberRank); ?>">
						</div>
					</div>
				</p>
