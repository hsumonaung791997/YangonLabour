...
// });
	...
	<?php endif; ?>
<form id="regForm" action="<?php echo e(route('shops.update',$shop->id)); ?>" method="post" enctype="multipart/form-data">
	  <?php echo csrf_field(); ?>
     <?php echo method_field('PUT'); ?>	 
		<!-- Circles which indicates the steps of the form: -->
  	<h1>ဆိုင် / အလုပ်ဌာန များ လုပ်ငန်းဌာနဆိုင်ရာ အချက်အလက်များ ပြင်ရန်</h1>
				  ...
				  <div class="row">
					  ...
					  <div class="col-sm-6 text-left">
						  <select id="township_id" class="form-control" name="township_id">
							  <option value="<?php echo e($shop->township_id); ?>"><?php echo e($township); ?></option>
						  </select>
					  </div>
				  </div> <br>
						  <div class="row">
							  ...
							  <div class="col-sm-6 text-left">
								  <textarea class="form-control form-control-alternative" rows="3" placeholder="အသေးစိတ်ထည့်ရန်" id='address' name="loacationaddress"><?php echo e($shop->loacationaddress); ?></textarea>
							  </div>
						  </div>
				...
				<div class="col-sm-12">
					<table style="width:100%" border="1">
					  ...
					  <tr>
					    ...
					    <td><input type='text' value="<?php echo e($shop->MenWorker); ?>" name="MenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->WomenWorker); ?>" name="WomenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->AMenWorker); ?>" name="AMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->AWomenWorker); ?>" name="AWomenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->CMenWorker); ?>" name="CMenWorker"></td>
					    <td><input type='text'  name="CWomenWorker" value="<?php echo e($shop->CWomenWorker); ?>"></td>
					  </tr>
					   <tr>
					    <td>နေ့စား</td>
					    <td><input type='text' value="<?php echo e($shop->DailyMenWorker); ?>" name="DailyMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->DailyWomenWorker); ?>" name="DailyWomenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->ADailyMenWorker); ?>" name="ADailyMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->ADailyWomenWorker); ?>" name="ADailyWomenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->CDailyMenWorker); ?>" name="CDailyMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->CDailyWomenWorker); ?>" name="CDailyWomenWorker"></td>
					  </tr>
					  <tr>
					    <td>ပုတ်ပြတ်</td>
					    <td><input type='text' value="<?php echo e($shop->PieceMenWorker); ?>" name="PieceMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->PieceWomenWorker); ?>" name="PieceWomenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->APieceMenWorker); ?>" name="APieceMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->APieceWomenWorker); ?>" name="APieceWomenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->CPieceMenWorker); ?>" name="CPieceMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->CPieceWomenWorker); ?>" name="CPieceWomenWorker"></td>
					  </tr>
					</table>
				</div>
			</div> <br>
			<p>&nbsp;ဆိုင်၊အလုပ်ဌာနရှိ နိုင်ငံသားအလုပ်သမားအရေအတွက် - </p>
				...
				<div class="col-sm-12">
					<table style="width:100%" border="1">
					  ...
					  <tr>
					    <td style="width: 100px;">လခစား</td>
					    <td><input type='text' value="<?php echo e($shop->MForeignerMenWorker); ?>" name="MForeignerMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->MForeignerWomenWorker); ?>" name="MForeignerWomenWorker"></td>
					  </tr>
					   <tr>
					    <td>နေ့စား</td>
					    <td><input type='text' value="<?php echo e($shop->DailyForeignerMenWorker); ?>" name="DailyForeignerMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->DailyForeignerWomenWorker); ?>" name="DailyForeignerWomenWorker"></td>
					  </tr>
					  <tr>
					    <td>ပုတ်ပြတ်</td>
					    <td><input type='text' value="<?php echo e($shop->PForeignerMenWorker); ?>" name="PForeignerMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->PForeignerWomenWorker); ?>" name="PForeignerWomenWorker"></td>
					  </tr>
					</table> <br>
				</div>
			</div> <br>
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
					...
					<select name="PropertyType" id="PropertyType" class="form-control">
						<option value="နိုင်ငံ" <?php if($shop->PropertyType=="နိုင်ငံ"): ?> selected <?php endif; ?>>နိုင်ငံ</option>
						<option value="သမဝါယမ" <?php if($shop->PropertyType=="သမဝါယမ"): ?> selected <?php endif; ?>>သမဝါယမ</option>
						<option value="ပုဂ္ဂလိက" <?php if( $shop->PropertyType=="ပုဂ္ဂလိက"): ?> selected <?php endif; ?>>ပုဂ္ဂလိက</option>
						<option value="နိုင်ငံခြား" <?php if( $shop->PropertyType =="နိုင်ငံခြား"): ?> selected <?php endif; ?>>နိုင်ငံခြား</option>
						<option value="ဖက်စပ်" <?php if($shop->PropertyType =="ဖက်စပ်"): ?> selected <?php endif; ?>>ဖက်စပ်</option>
					</select>
	  			</div>
	  			<div class="col-sm-1">
	  		...
	  		<div class="row">
	  			...
	  			<div class="col-sm-6 text-center">
					...
					<select name="Investment" id="investment" class="form-control">
						<option value="LDI" <?php if($shop->Investment=="LDI"): ?> selected <?php endif; ?>>LDI</option>
						<option value="FDI" <?php if($shop->Investment=="FDI"): ?> selected <?php endif; ?>>FDI</option>
					</select>
	  			</div>
	  		</div>
	  	</p>
				...
				<div class="col-sm-12">
					<table style="width:100%" border="1">
					  ...
					  <tr>
					    ...
					    <td><input type='text' value="<?php echo e($shop->CitizenMenWorker); ?>"  style="width: 70px !important;" name="CitizenMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->CitizenWomenWorker); ?>" style="width: 70px !important;" name="CitizenWomenWorker"></td>
					  </tr>
					   <tr>
					    <th>နိုင်ငံခြားသားလုပ်သား</th>
					    <td><input type='text' value="<?php echo e($shop->ForeignerMenWorker); ?>" style="width: 70px !important;" name="ForeignerMenWorker"></td>
					    <td><input type='text' value="<?php echo e($shop->ForeignerWomenWorker); ?>" style="width: 70px !important;" name="ForeignerWomenWorker"></td>
					  </tr>
					</table> <br>
				</div>
			</div>
		  		...
		  		<div class="row">
		  			<div class="col-sm-5 text-center">
						...
						<select name="SalaryDate" id="SalaryDate" class="form-control">
							<option value="လကုန်ရက်" <?php if($shop->SalaryDate=='လကုန်ရက်'): ?> selected <?php endif; ?>>လကုန်ရက်</option>
							<option value="လဆန်း(၁)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၁)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၁)ရက်</option>
							<option value="လဆန်း(၂)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၂)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၂)ရက်</option>
							<option value="လဆန်း(၃)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၃)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၃)ရက်</option>
							<option value="လဆန်း(၄)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၄)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၄)ရက်</option>
							<option value="လဆန်း(၅)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၅)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၅)ရက်</option>
							<option value="လဆန်း(၆)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၆)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၆)ရက်</option>
							<option value="လဆန်း(၇)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၇)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၇)ရက်</option>
							<option value="လဆန်း(၈)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၈)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၈)ရက်</option>
							<option value="လဆန်း(၉)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၉)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၉)ရက်</option>
							<option value="လဆန်း(၁၀)ရက်" <?php if($shop->SalaryDate=='လဆန်း(၁၀)ရက်'): ?> selected <?php endif; ?>>လဆန်း(၁၀)ရက်</option>
