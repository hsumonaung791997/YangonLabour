...
$('#datepicker').datepicker({
	...
	<h1>စစ်ဆေးချက်ပုံစံဆိုင်များနှင့် အလုပ်ဌာနများ အက်ဥပဒေ ခွင့်ရက်နှင့် အလုပ်ပိတ်ရက် ဥပဒေစစ်ဆေးခြင်း</h1>
		...
		<form id="regForm" action="<?php echo e(route('shop_inspection.store')); ?>" method="post">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="row">
								...
								<div class="col-sm-7">
									<input type='date' id="datepicker" class="form-control" name="inspectiondate" value="<?php echo e(old('inspectiondate')); ?>" required/>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="row">
								...
								<div class="col-sm-7">
									<input type='date' id="lastinspectiondate" class="form-control" name="lastinspectiondate" value="<?php echo e(old('lastinspectiondate')); ?>" id="lastinspectiondate"/>
								</div>
							</div>
						</div>		
					</div>
						...
						<div class="row">
							...
							<div class="col-sm-7">
								<select name='inspectedtime' id="testingtime" class="form-control">
									<option value='ပထမအကြိမ်' <?php if(old('inspectedtime')=='ပထမအကြိမ်'): ?> selected <?php endif; ?>>ပထမအကြိမ်</option>
									<option value='ဒုတိယအကြိမ်' <?php if(old('inspectedtime')=='ဒုတိယအကြိမ်'): ?> selected <?php endif; ?>>ဒုတိယအကြိမ်</option>
									<option value='တတိယအကြိမ်' <?php if(old('inspectedtime')=='တတိယအကြိမ်'): ?> selected <?php endif; ?>>တတိယအကြိမ်</option>
									<option value='စတုတ္ထအကြိမ်' <?php if(old('inspectedtime')=='စတုတ္ထအကြိမ်'): ?> selected <?php endif; ?>>စတုတ္ထအကြိမ်</option>
									<option value='ပဉ္စမအကြိမ်' <?php if(old('inspectedtime')=='ပဉ္စမအကြိမ်'): ?> selected <?php endif; ?>>ပဉ္စမအကြိမ်</option>
									<option value='ဆဌမအကြိမ်' <?php if(old('inspectedtime')=='ဆဌမအကြိမ်'): ?> selected <?php endif; ?>>ဆဌမအကြိမ်</option>
									<option value='သတ္တမအကြိမ်' <?php if(old('inspectedtime')=='သတ္တမအကြိမ်'): ?> selected <?php endif; ?>>သတ္တမအကြိမ်</option>
									<option value='အဌမအကြိမ်' <?php if(old('inspectedtime')=='အဌမအကြိမ်'): ?> selected <?php endif; ?>>အဌမအကြိမ်</option>
									<option value='နဝမအကြိမ်' <?php if(old('inspectedtime')=='နဝမအကြိမ်'): ?> selected <?php endif; ?>>နဝမအကြိမ်</option>
									<option value='ဒဿမအကြိမ်' <?php if(old('inspectedtime')=='ဒဿမအကြိမ်'): ?> selected <?php endif; ?>>ဒဿမအကြိမ်</option>
						...
						<div class="row">
								...
								<div class="col-sm-7">
									<select name='inspection_type' id="testingtime" class="form-control">
										<option value='ပုံမှန်' <?php if(old('inspection_type')=='ပုံမှန်'): ?> selected <?php endif; ?>>ပုံမှန်</option>
										<option value='ပြန်လည်' <?php if(old('inspection_type')=='ပြန်လည်'): ?> selected <?php endif; ?>>ပြန်လည်</option>
										<option value='တုံ့ပြန်' <?php if(old('inspection_type')=='တုံ့ပြန်'): ?> selected <?php endif; ?>>တုံ့ပြန်</option>
										<option value='အထူး' <?php if(old('inspection_type')=='အထူး'): ?> selected <?php endif; ?>>အထူး</option>
										<option value='လျှပ်တစ်ပြတ်' <?php if(old('inspection_type')=='လျှပ်တစ်ပြတ်'): ?> selected <?php endif; ?>>လျှပ်တစ်ပြတ်</option>
									</select>
								</div>
						</div>
					</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-6 ">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<textarea name="shopaddress" id="shopadddress" class="col-sm-12 form-control" rows="3"><?php echo e(old('shopaddress')); ?></textarea>
	  					</div>
	  				</div>
	  			...
	  			<div class="col-sm-6">
	  			 <div class="row">
	  				<div class="col-sm-5 text-right">
	  					...
	  					<div class="col-sm-7">
	  						<input type="text" name="property" id="property" class="form-control" value="<?php echo e(old('property')); ?>">
	  					</div>
	  				</div>
	  			</div>
	  	</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-6">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<input type="text" name="ownername" id="ownername" class="form-control" value="<?php echo e(old('ownername')); ?>">
	  					</div>
	  				</div>
	  			...
	  			<div class="col-sm-6">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<textarea name="owneraddress" id="owneraddress" class="col-sm-12 form-control"><?php echo e(old('owneraddress')); ?></textarea>
	  					</div>
	  				</div>
	  			</div>
	  		</div>
	  			...
	  			<div class="col-sm-6 text-center">
		  			...
		  			<div class="col-sm-6">
		  				<div class="row">
		  					...
		  					<div class="col-sm-7">
		  						<input type="text" name="workcategory" id="workcategory" class="form-control" value="<?php echo e(old('workcategory')); ?>">
		  					</div>
		  				</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-6">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<input type="text" name="managername" id="managername" class="form-control" value="<?php echo e(old('managername')); ?>">
	  					</div>
	  				</div>
	  			...
	  			<div class="col-sm-6">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<textarea name="manageraddress" id="manageraddress" class="col-sm-12 form-control"><?php echo e(old('manageraddress')); ?></textarea>
	  					</div>
	  				</div>
	  			</div>
	  		</div>
	  		...
	  		<div class="row">
	  			<div class="col-sm-6 text-center">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<input type="text" name="intervieweename" id="intervieweename" class="form-control" value="<?php echo e(old('intervieweename')); ?>">
	  					</div>
	  				</div>
	  			...
	  			<div class="col-sm-6 text-left">
	  				<div class="row">
	  					...
	  					<div class="col-sm-7">
	  						<textarea name="intervieweenamerank" id="intervieweenamerank" class="col-sm-12 form-control"><?php echo e(old('intervieweenamerank')); ?></textarea>
	  					</div>
	  				</div>
	  			</div>
	  		</div>
		...
		<div>
			<table border="1" style="width:100%;table-layout:fixed;border-spacing:20px 40px;font-size:16px; line-height:24px; font-weight:100;" class="bodywrapcenter">
				...
				<tbody>
					<tr>
						<th>ကျား</th>
						<td><input type='text' class="form-control" value=<?php if(old('above18m')==null): ?> 0 <?php else: ?> <?php echo e(old('above18m')); ?> <?php endif; ?>  name="above18m" id="above18m" onkeyup="converunistring('man')"></td>
						<td><input type='text' class="form-control" value=<?php if(old('above15m')==null): ?> 0 <?php else: ?> <?php echo e(old('above15m')); ?> <?php endif; ?>  name="above15m" id="above15m" onkeyup="converunistring('man')"></td>
						<td><input type='text' class="form-control" value=<?php if(old('above13m')==null): ?> 0 <?php else: ?> <?php echo e(old('above13m')); ?> <?php endif; ?>   name="above13m" id="above13m" onkeyup="converunistring('man')"></td>
						<td><input type='text' class="form-control" value="<?php echo e(old('totalm')); ?>"  name="totalm" id="totalm"></td>
					</tr>

					<tr>
						<th>မ</th>
						<td><input type='text' class="form-control" value=<?php if(old('above18f')==null): ?> 0 <?php else: ?> <?php echo e(old('above18f')); ?> <?php endif; ?> name="above18f" id="above18f" onkeyup="converunistring('women')"></td>
						<td><input type='text' class="form-control" value=<?php if(old('above15f')==null): ?> 0 <?php else: ?> <?php echo e(old('above15f')); ?> <?php endif; ?> name="above15f" id="above15f" onkeyup="converunistring('women')"></td>
						<td><input type='text' class="form-control" value=<?php if(old('above13f')==null): ?> 0 <?php else: ?> <?php echo e(old('above13f')); ?> <?php endif; ?> name="above13f" id="above13f" onkeyup="converunistring('women')"></td>
						<td><input type='text' class="form-control" value="<?php echo e(old('totalf')); ?>"  name="totalf" id="totalf"></td>
					</tr>
				</tbody>
			</table> 
		</div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                             <input name="inspection_name" id="inspection_name" class="form-control" value="<?php echo e(old('inspection_name')); ?>" required> 
                ...
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                             <input name="inspectorrank" id="inspectorrank" class="form-control" value="<?php echo e(old('inspectorrank')); ?>" required> 
                        </div>
                    </div>
                </div>
            </div>
