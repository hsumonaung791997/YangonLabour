...
<?php endif; ?>
	...
	<form id="regForm"class="form-background" action="<?php echo e(route('FactoryInspectionSafety.store')); ?>" method="post">
	 <?php echo e(csrf_field()); ?>
	  ...
	  <input type="hidden" name="township_id" id="township_id" value="<?php echo e(old('township_id')); ?>">
	  		...
	  		<div class="row">
	  			<div class="col-sm-5 text-center">
	  				...
	  				<input id="FactoryName" class="form-control" name="factoryname" value="<?php echo e(old('factoryname')); ?>">
	  		...
	  		<!-- <div class="row">
	  			<div class="col-sm-5 text-center">
					  <label for="ownername">အလုပ်ရုံပိုင်ရှင်အမည် </label>
	  				  <input id="ownername"  name="ownername" class="form-control" value="<?php echo e(old('ownername')); ?>">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<!-- <div class="col-sm-6 text-center">
	  				...
	  				<input id="owneraddress"  name="owneraddress" class="form-control" value="<?php echo e(old('owneraddress')); ?>">
	  			</div> 
	  		</div>-->
	  		<!-- <div class="row">
	  			<div class="col-sm-5 text-center">
					  <label for="factoryOwnerNrc">မှတ်ပုံတင်လုပ်ငန်းပိုင်ရှင် အမည် </label>
	  				<input id="factoryOwnerNrc" class="form-control" name="factoryOwnerNrc" value="<?php echo e(old('factoryOwnerNrc')); ?>">
	  			</div>
	  			<div class="col-sm-1">
	  			...
	  			<div class="col-sm-6 text-center">
	  				...
	  				<input id="factoryOwnerAddress" class="form-control" name="factoryOwnerAddress" value="<?php echo e(old('factoryOwnerAddress')); ?>">
	  			</div>
	  		</div> -->
	  		<!-- <div class="row">
	  			<div class="col-sm-5 text-center">
						    ...
						    <div class="control-group">
							    <div class="row">
								 	<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="ကျား" name="menworker" value="<?php echo e(old('menworker')); ?>" id="menworker" class="form-control" onkeyup="converunistring()"/>
									</div>
									<div class="col-sm-4 text-center">
								 		<input type="text" placeholder="မ" name="womenworker"  value="<?php echo e(old('womenworker')); ?>" id="womenworker" class="form-control" onkeyup="converunistring()"/>
									</div>
									<div class="col-sm-4 text-center">
			...
			<p>
				<div class="row">				
		  			<div class="col-sm-6 text-center">
							...
							<div class="control-group">
								<div class="row">
								<textarea class="col-sm-12" name="sittingplan" rows="5" placeholder="တွေ့ရှိချက်"><?php echo e(old('sittingplan')); ?></textarea>
								</div>
							</div>
						</fieldset>
		  			</div>
		...
		<p><textarea class='col-sm-12 form-control' name="change5" rows="3"><?php echo e(old('change5')); ?></textarea></p>
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<input type="text" name="inspectorname" id="inspectorname" class="form-control" value="<?php echo e(old('inspectorname')); ?>"/>
						
				</div>
				<div class="col-sm-4">
					<label for="inspectorrank">စစ်ဆေးသူအရာရှိ ရာထူး <span style="color:red;">*</span></label>
					<input type="text" name="inspectorrank" id="inspectorrank" class="form-control" value="<?php echo e(old('inspectorrank')); ?>"/>
				</div>
			</div>
	  </div>
	  <div class="blank10"></div>
