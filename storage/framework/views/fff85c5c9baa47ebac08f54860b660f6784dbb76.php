        ...
        <?php $__currentLoopData = $affected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td scope="row" class="name">
                    ...
                    <a href="<?php echo e(url('/impactworkerinform/'.$aff->id)); ?>" class="badge badge-pill badge-primary"> စစ်ဆေးချက် ပြင်မည်</a> <br>
                    <a href="<?php echo e(url('/CreateImpactInstruction/'.$aff->id.'/'.$aff->FactoryID.'/'.$aff->Type)); ?>" class="badge badge-pill badge-success"> ညွှန်ကြားချက်ထုတ်မည် </a> <br>
                    <?php endif; ?>
