			  ...
			  <div class="row" id="law3">
		  		...
		  		<div class="row">
		  			...
		  			<div class="col-sm-6 text-center">
		  				...
		  				<input id="SignatureRank" class="form-control" oninput="this.className = ''" name="SignatureRank" value="<?php echo e(old('SignatureRank')); ?>">
						  <span style="color:red;">*</span>
		  			</div>
		  		</div>
					...
					<div class="row">
						...
						<div class="col-sm-6 text-center">
							...
							<input id="SubscriberRank" class="form-control" oninput="this.className = ''" name="SubscriberRank" value="<?php echo e(old('SubscriberRank')); ?>">
						</div>
					</div>
				</p>
	  </div>
