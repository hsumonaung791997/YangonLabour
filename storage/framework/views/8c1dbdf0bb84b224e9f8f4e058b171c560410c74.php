        ...
        <?php endif; ?>
                ...
                <li class="dropdown">
                       <a class="nav-link dropbtn" >
                           <i class="fa fa-tasks"></i> လုပ်ငန်းခွင်ထိခိုက်မှု
                       </a>
                           
                      
                           <div class="dropdown-content">
                                <a href="<?php echo e(url('AffectedIndex')); ?>">ထိခိုက်မှုအကြောင်းကြားခြင်းပုံစံ </a>
         ...
         <?php if($roleid==1): ?>
             ...
             <li class="dropdown">
                 <a class="nav-link dropbtn" >
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('register')); ?>">User Tracking</a>
                        <a href="">User Log</a>
        ...
        <?php endif; ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('logout')); ?>">
                             <i class="ni ni-key-25 text-info"></i> အကောင့်မှထွက်ခြင်း
                    </a>
                </li>
            </ul>
