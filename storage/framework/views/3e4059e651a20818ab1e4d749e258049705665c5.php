...
<form method="post" name="testform" action="<?php echo e(url('instructionupdate')); ?>">
  ...
  <p>
     <div class="row">
        <div class="col-sm-6">
          <div class="row">
            ...
            <div class="col-sm-6">
              <input type="text" value="<?php echo e($ins->instructor); ?>" name="instructor" id="instructor">
        ...
        <div class="col-sm-6">
          <div class="row">
            ...
            <div class="col-sm-6">
              <input type="text" id="instructorrank" name="instructorrank" value="<?php echo e($ins->instructor_rank); ?>">
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <input type="text" id="inspectiontype_id" value="<?php if($ins->inspectiontype_id==1): ?> အလုပ်သမားဥပဒေစစ်ဆေးရေး <?php elseif($ins->inspectiontype_id==2): ?> အလုပ်ရုံစစ်ဆေးရေး <?php endif; ?>" name="inspectiontype_id"/>
 ...
 <?php if($ins->inspectiontype_id==1): ?>
  <div class="row">
      ...
      <div class="col-sm-8">
        <textarea  name="aleavedesc" id="aleavedesc" class="col-sm-12"  rows="4"><?php echo e($ins->a_leavedesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" id="aleaveno" name="aleaveno" value="<?php echo e($ins->a_leave); ?>" ></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">လုပ်ခ/လစာ</label></div>
      <div class="col-sm-8">
        <textarea  name="awagedesc" class="col-sm-12"  rows="4" id="awagedesc"><?php echo e($ins->a_wagedesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" name="awageno" value="<?php echo e($ins->a_wages); ?>"  id="awageno"></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">မှတ်တမ်း</label></div>
      <div class="col-sm-8">
        <textarea  name="anotedesc" class="col-sm-12"  rows="4" id="anotedesc"><?php echo e($ins->a_notedesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" name="anoteno" value="<?php echo e($ins->a_note); ?>"  id="anoteno"></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">အလုပ်ချိန်</label></div>
      <div class="col-sm-8">
        <textarea  name="aworktimedesc" id="aworktimedesc" class="col-sm-12"  rows="4"><?php echo e($ins->a_worktimedesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" id="aworktimeno" name="aworktimeno" value="<?php echo e($ins->a_worktime); ?>" ></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">အခြား</label></div>
      <div class="col-sm-8">
        <textarea  name="aotherdesc" id="aotherdesc" class="col-sm-12" rows="4" ><?php echo e($ins->a_otherdesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" id="aotherno" name="aotherno" value="<?php echo e($ins->a_other); ?>" ></div>
      </div>
  <?php elseif($ins->inspectiontype_id==2): ?>
  <div class="row">
       <div class="col-sm-3"><label for="ContactFax">ဘေးကင်း</label></div>
      <div class="col-sm-8">
        <textarea  name="fsafetydesc" id="fsafetydesc" class="col-sm-12" rows="4" ><?php echo e($ins->f_safetydesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" id="fsafetyno" name="fsafetyno" value="<?php echo e($ins->f_safety); ?>" ></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">
ကျန်းမာ</label></div>
      <div class="col-sm-8">
        <textarea  name="fhealthdesc" class="col-sm-12"  rows="4" id="fhealthdesc"><?php echo e($ins->f_healthdesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" id="fhealthno" name="fhealthno" value="<?php echo e($ins->f_health); ?>" ></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">သက်သာ</label></div>
      <div class="col-sm-8">
        <textarea  name="fwelfaredesc" id="fwelfaredesc" class="col-sm-12" rows="4" ><?php echo e($ins->f_welfaredesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" name="fwelfareno" id="fwelfareno" value="<?php echo e($ins->f_welfare); ?>" ></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">မှတ်တမ်း</label></div>
      <div class="col-sm-8">
        <textarea  name="fnotedesc" id="fnotedesc" class="col-sm-12" rows="4" ><?php echo e($ins->f_notedesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" name="fnoteno" id="fnoteno" value="<?php echo e($ins->f_note); ?>" ></div>
      </div>
      <div class="row">
       <div class="col-sm-3"><label for="ContactFax">အခြား</label></div>
      <div class="col-sm-8">
        <textarea  name="fotherdesc" id="fotherdesc" class="col-sm-12" rows="4" ><?php echo e($ins->f_otherdesc); ?></textarea>
      </div>
      <div class="col-sm-1"><input type="text" id="fotherno" name="fotherno" value="<?php echo e($ins->f_other); ?>" ></div>
      </div>
