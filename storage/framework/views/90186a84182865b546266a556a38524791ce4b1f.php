...
<body>
    <div style="padding : 2% 2% 2% 2%">
        ...
        <p style="text-align:center;">(<?php echo e($shopinform->inspectedtime); ?>/<?php 
        ...
        <table align="center" style="width:100%;">
            <tbody>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shopinform->shopname); ?>-<?php echo e($shopinform->shopaddress); ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td>(ခ) ပိုင်ဆိုင်မှု အမျိုးအစား</td>
                    <td>-</td>
                    <td><?php echo e($shopinform->property); ?></td>
                </tr>
                <tr>
                    <td>၂။</td>
                    ...
                    <td>-</td>
                    <td>
                    <?php echo e($shopinform->ownername); ?>-<?php echo e($shopinform->owneraddress); ?><br>
                    <?php  
                         $sharename = App\Share::where('shop_inform_id',$shop_labourlaw->check_id)->get();
                    ?>
                    <?php $__currentLoopData = $sharename; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($shop_labourlaw->check_id == $n->shop_inform_id): ?>
                    <?php echo e($n->share); ?> 
                    <br>
                    <?php endif; ?>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shopinform->managername); ?> - <?php echo e($shopinform->manageraddress); ?></td>
                </tr>
                <tr>
                    <td>၄။</td>
                    ...
                    ?>
                    <td>
                    <?php $__currentLoopData = $shopname; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($shop_labourlaw->check_id == $s->shop_inform_id): ?>
                    <?php echo e($s->othershopname); ?> ၊ 
                    <?php echo e($s->othershopaddress); ?> <br>
                    <?php endif; ?>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </td>
                </tr>
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shopinform->intervieweename); ?> - <?php echo e($shopinform->intervieweenamerank); ?></td>
                </tr>
                <tr>
                    <td>၆။</td>
                    <td>လုပ်ငန်းအမျိုးအစား</td>
                    <td>-</td>
                    <td><?php echo e($shopinform->workcategory); ?></td>
                </tr>
            </tbody>
        </table>
        <br>
        <table border="1" align="right" style="border-collapse:collapse;width:100%;">
            ...
            <tbody>
                <tr style="text-align:center">
                    ...
                    <td style="text-align:center;"><?php echo e($shopinform->above18m); ?></td>
                    <td style="text-align:center;"><?php echo e($shopinform->above15m); ?></td>
                    <td style="text-align:center;"><?php echo e($shopinform->above13m); ?></td>
                    <td style="text-align:center;"><?php echo e($shopinform->totalm); ?></td>
                </tr>
                <tr style="text-align:center">
                    <td style="text-align:center;">မ</td>
                    <td style="text-align:center;"><?php echo e($shopinform->above18f); ?></td>
                    <td style="text-align:center;"><?php echo e($shopinform->above15f); ?></td>
                    <td style="text-align:center;"><?php echo e($shopinform->above13f); ?></td>
                    <td style="text-align:center;"><?php echo e($shopinform->totalf); ?></td>
                </tr>
                <!-- <tr style="text-align:center">
        ...
        <table border="1" align="center" style="border-collapse:collapse;width:100%;">
            <tbody>
               ...
               <?php $__currentLoopData = $shopworker; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="text-align:center;"><?php echo e($w->name); ?></td>
                    <td style="text-align:center;"><?php echo e($w->position); ?></td>
                    <td style="text-align:center;"><?php echo e($w->salary); ?></td>
                    <td style="text-align:center;"><?php echo e($w->daily_work_hours); ?> </td>
                    <td style="text-align:center;"><?php echo e($w->break_time); ?> </td>
                    <td style="text-align:center;"><?php echo e($w->weekly_off_day); ?> </td>
                    <td style="text-align:center;">
                    <?php 
                    ...
                    <td style="text-align:center;"><?php echo e($w-> note); ?></td>
                </tr>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <table align="center" style="width:100%;">
            <tbody>
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->work_duration); ?></td>
                </tr>
                <tr>
                    <td>၉။</td>
                    <td>ရက်သတ္တပတ်ပိတ်ရက်၊ နားရက်</td>
                    <td>-</td>
                    <td> <?php echo e($shop_labourlaw->weekend_holiday); ?> </td>
                </tr>
                <tr>
                    <td>၁၀။</td>
                    <td>အလုပ်ချိန်နို.တစ်စာပုံစံ ၁(က)/ ၁(ခ)/ ၁(ဂ) ကိုချိတ်ဆွဲထားခြင်း ပြု/မပြု</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->worktime_notice); ?></td>
                </tr>
                <tr>
                    <td>၁၁။</td>
                    <td>အလုပ်သမား မှတ်ပုံတင်စာအုပ် ထား/မထား</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->SSB); ?></td>
                </tr>
                <tr>
                    <td>၁၂။</td>
                    <td>အခကြေးငွေကို လကုန်ပြီး(၇)ရက်အတွင်း ပေး/မပေး</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->salary_time); ?></td>
                </tr>
            </tbody>
        </table>
        <br>
        ...
        <table align="center" style="width:100%;">
            <tbody>
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->registrationbook); ?></td>
                </tr>
                <tr>
                    <td>၂။</td>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->numholidays); ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td>(ခ) အလုပ်သမားများအား အများအလုပ်ပိတ်ရက် ခံစားခွင့် ပြု/မပြု</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->opportunityhol); ?></td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->paidwage); ?></td>
                </tr>
                <tr>
                    <td>၃။</td>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->vacationdays); ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td>(ခ) နှစ်စဉ်ခံစားခြင်းမရှိပါက သုံးနှစ်ထိ စုဆောင်းမှု ရှိ/မရှိ</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->annual); ?></td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->workerfrees); ?></td>
                </tr>
                <tr>
                    <td>၄။</td>
                    <td>တစ်နှစ်လျှင် ခံစားခွင့်ပြုသော ဆေးလက်မှတ် အရေအတွက်<br>(ခံစားခွင့်မရသော အလုပ်သမားရှိက ဖော်ပြရန်)</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->medicalticketqan); ?> <br> </td>
                </tr>
                <tr>
                    <td>၅။</td>
                    <td>တစ်နှစ်လျှင် ခံစားခွင့်ပြုသော ဆေးလက်မှတ် အရေအတွက်<br>(ခံစားခွင့်မရသော အလုပ်သမားရှိက ဖော်ပြရန်)</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->medicalticketqan); ?> </td>
                </tr>
                <tr>
                    <td>၆။</td>
                    <td>ယခင်က ပြစ်မှုထင်ရှား စီရင်ခြင်း ခံရလျှင် အဆိုပါ အကြောင်းအရာများကို ဖော်ပြရန်</td>
                    <td>-</td>
                    <td><?php echo e($shop_labourlaw->passionremark); ?></td>
                </tr>
            </tbody>
        </table>
        <br>
        ...
        <table align="center" style="width:100%">
            <tbody>
                ...
                <tr>
                    <td><?php echo e($shop_labourlaw->generalremark); ?></td>
                    <td></td>
                </tr>
            </tbody>
        </table>
